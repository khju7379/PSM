<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SabunMultiChkPopup8.aspx.cs" Inherits="TaeYoung.Portal.PSM.POP.SabunMultiChkPopup8"%>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="conBody" runat="server">
    ...
    <div>
        ...
        <ext:Panel ID="pnlMain" runat="server" Layout="VBoxLayout" Icon="Money" Title="점검자 조회" Border="true" Padding="2" Width = "600" Height = "380">
            <LayoutConfig>
            ...
            <Items>
                <ext:Panel ID="Panel1" runat="server" Region="North" Border="false" Frame = "true" width = "600">
                    ...
                    <Items>
                        ...
                        <ext:Button ID="Button6" runat="server" Text="점검자 지정" Icon="Accept">
                            <Listeners>
                                <Click Handler="btnSelect_ClientClick();" />
                            </Listeners>
                        </ext:Button>
                        <ext:ToolbarSpacer ID="ToolbarSpacer1" runat="server" Width="10"></ext:ToolbarSpacer>
                        <ext:Button ID="Button7" runat="server" Text="점검자 삭제" Icon="Delete">
                            <Listeners>
                ...
                <ext:Panel ID="grdList" runat="server" Region="Center" Layout = "HBoxLayout" width = "600" Height = "300">
                    ...
                    <Items>
                        <ext:Panel ID="Panel2" runat = "server" Layout = "VBoxLayout" Width = "260" Height = "300">
                            ...
                            <Items>
                                <ext:Panel ID="pnlMenu" runat="server" Layout="AccordionLayout" Border="true" Width="240px"  Frame="false" OverflowY = "Auto" Height = "320" AnimCollapse="false">
                                    <LayoutConfig>
                                ...
                                <ext:TreePanel ID="pnlReference" runat="server" Border="true" WIDTH ="240px" Frame ="false" OverflowY = "Auto" Height = "300"
                                    ...
                                    <Listeners>
                                        <CheckChange Handler="checkchange()" ></CheckChange>
                                    </Listeners>
                                </ext:TreePanel>
                            </Items>
                        </ext:Panel>
                                    ...
                                    <Items>
                                        <ext:RadioGroup ID="RadioGroup1" runat="server" Layout="HBoxLayout" flex = "1">
                                            ...
                                            <Items>
                                                ...
                                                <ext:Radio ID="rdoGUBUN1" runat="server" Margins="0 0 0 5" Checked = "true" Visible="false">
                                                    <Listeners>
                                                        <%--<Blur Handler="chk_ClientChange(2);"></Blur>--%>
                                                        <Focus Handler="chk_ClientChange(1);"></Focus>
                                                    </Listeners>
                                                </ext:Radio>
                                                <ext:Label ID="Label2" runat="server" Width ="60" Text="요청결재" Margins="1 0 0 5" Visible="false"></ext:Label>

                                                <ext:Radio ID="rdoGUBUN2" runat="server" Margins="0 0 0 5" Visible="false">
                                                    <Listeners>
                                                        <%--<Blur Handler="chk_ClientChange(1);"></Blur>--%>
                                                        <Focus Handler="chk_ClientChange(2);"></Focus>
                                                    </Listeners>
                                                </ext:Radio>
                                                <ext:Label ID="lblGUBUN2" runat="server" Width ="60" Text="수신결재" Margins="1 0 0 5" Visible="false"></ext:Label>

                                                <ext:Radio ID="rdoGUBUN3" runat="server" Margins="1 0 0 5" Visible="false">
                                                    <Listeners>
                                                        <%--<Blur Handler="chk_ClientChange(1);"></Blur>--%>
                                                        <Focus Handler="chk_ClientChange(3);"></Focus>
                                                    </Listeners>
                                                </ext:Radio>
                                                <ext:Label ID="Label3" runat="server" Width ="70" Text="참조자" Margins="1 0 0 5" Visible="false"></ext:Label>
                                    ...
                                    <Items>
                                        <ext:GridPanel runat="server" ID="GridPanel2" EnableDragDrop="false" Width = "260" Height = "300">
                                            ...
                                            <ColumnModel ID="ColumnModel2" runat="server">
	                                            <Columns>
                                                    <ext:Column runat="server" Text="순번"     DataIndex="SEQ"     Sortable = "false" width = "30"  Hidden = "true"></ext:Column>
                                                    <ext:Column runat="server" Text="사번"     DataIndex="KBSABUN" Sortable = "false" Flex="30"></ext:Column>
                                                    <ext:Column runat="server" Text="이름"     DataIndex="KBHANGL" Sortable = "false" Flex="70"></ext:Column>
                                        ...
                                        <ext:GridPanel runat="server" ID="GridPanel5" EnableDragDrop="false" Width = "260" Height = "300">
                                            <Store>
