<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PSM4090.aspx.cs" Inherits="TaeYoung.Portal.PSM.PSM40.PSM4090" %>
...
<asp:content id="HeaderContent" runat="server" contentplaceholderid="conHead">
    ...
    <script type="text/javascript">
        ...
        function btnExcon_Click() {
            ...
            fn_OpenPopCustom("PSM4071.aspx?param=NEW&param2=2", 1400, 800, "Excon");
        }
        ...
        function gridClick(r, c)
        {
            ...
            fn_OpenPopCustom("PSM4091.aspx?param=NEW&param1=" + param, 1200, 1000, param);
        ...
        function grdEXAMClick(r, c) {
            ...
            fn_OpenPopCustom("PSM4091.aspx?param=UPT&param1=" + param, 1200, 1000, param);
        }
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="conBody">  
    ...
    <!--컨텐츠시작-->
    <div id="content">
        <Ctl:Layer ID="layer1" runat="server" Title="탱크 저장물질 변경에 따른 가동전 점검" DefaultHide="False">
            <!-- 상단의 버튼을 정의 -->
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    <td valign="top">
                        <Ctl:WebSheet ID="grdWorkList" runat="server" Paging="false" CheckBox="false" HFixation="true"   Height="240" Width="100%" TypeName="PSM.PSM4090" MethodName="UP_GET_WORKORDER_LIST" UseColumnSort="true" HeaderHeight="10" CellHeight="20">
                            ...
                            <Ctl:SheetHeader TextField="tColumns6" Description="요청부서"    Align="center" Colspan="2" RowSpan="1" RowIndex="1" ColIndex="6" runat="server" />
                            <Ctl:SheetHeader TextField="tColumns7" Description="수신부서"    Align="center" Colspan="2" RowSpan="1" RowIndex="1" ColIndex="8" runat="server" />
                            <Ctl:SheetHeader TextField="tColumns8" Description="작업기간"    Align="center" Colspan="2" RowSpan="1" RowIndex="1" ColIndex="10" runat="server" />
                            <Ctl:SheetHeader TextField="tColumns9" Description="상태"        Align="center" Colspan="1" RowSpan="2" RowIndex="1" ColIndex="12" runat="server" />
