<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PSM4012.aspx.cs" Inherits="TaeYoung.Portal.PSM.PSM40.PSM4012" %>
    ...
    <script type="text/javascript">
        ...
        function btnApproval_Click() {
            ...
            if (opener) {
                ...
                opener.btnPopup_Callback(txtCOMMENT1.GetValue());
                self.close();
            }
            else {
                alert("대상이 없습니다.");
