<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PSM4100.aspx.cs" Inherits="TaeYoung.Portal.PSM.PSM40.PSM4100" %>
...
<asp:content id="HeaderContent" runat="server" contentplaceholderid="conHead">
    ...
    <script type="text/javascript">
        ...
        function btnNew_Click() {
            ...
            fn_OpenPopCustom("PSM4101.aspx?CODE=" + CODE, 800, 680, CODE);
        }
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="conBody">  
    ...
    <!--컨텐츠시작-->
    <div id="content">
        <Ctl:Layer ID="layer1" runat="server" Title="개선항목 실행 계획서" DefaultHide="False">
                                ...
                                <tr>
                                    <td style="text-align:left;">
                                        <div style="height:750px;width:220px; overflow-y:auto; overflow-x:auto;" >
                                            <Ctl:WebTree ID="wtBoardlist" runat="server" CheckBox="false" Description="개선항목 실행 계획서" HideTitle="true" IndexBindFiledName="MENU_NO" EnableSearchBox="false"
                            ...
                            <table class="table_01" style="width: 100%;">    
                                ...
                                <tr>
                                    <td colspan="7" style="text-align:left;border:none;">
                                        <div>
                                            <Ctl:Text ID="txtPBMLCODEPL" runat="server" LangCode="txtPBMLCODEPL" Description="개선항목 실행 계획서"></Ctl:Text>
                                        </div>
                                    </td>
                                </tr>
                                <tr >
