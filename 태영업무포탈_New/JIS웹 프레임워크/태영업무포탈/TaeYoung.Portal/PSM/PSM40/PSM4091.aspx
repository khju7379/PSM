<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PSM4091.aspx.cs" Inherits="TaeYoung.Portal.PSM.PSM40.PSM4091" %>
...
<asp:content id="HeaderContent" runat="server" contentplaceholderid="conHead">
    ...
    <script type="text/javascript">
        ...
        function fn_Field_ReadOnly(bReadOnly, bReadOnly1) {
            ...
            txtPECDATE.SetDisabled(bReadOnly1);

            svPECTANKNO.SetDisabled(bReadOnly);
            if (bReadOnly == true) {
                $("#svPECTANKNO_TNTANKNO_img").attr("style", "display:none");
            }
            else {
                $("#svPECTANKNO_TNTANKNO_img").attr("style", "display:");
            }
            
            txtPECTITLE.SetDisabled(bReadOnly);
            txtPECINSDATE.SetDisabled(bReadOnly);
            txtPECFAULTNM.SetDisabled(bReadOnly);
            txtPECIMPROVE.SetDisabled(bReadOnly);
        ...
        function fn_GET_Display() {
            ...
            PageMethods.InvokeServiceTable(ht, "PSM.PSM4090", "UP_EXAM_CHECK_RUN", function (e) {
                ...
                if (ObjectCount(DataSet.Tables[0].Rows) > 0) {
                    ...
                    // 탱크번호
                    svPECTANKNO.SetValue(DataSet.Tables[0].Rows[0]["PECTANKNO"]);
                    ...
                    if (DataSet.Tables[0].Rows[0]["PECSDATE"] != "") {
                    ...
                    // 점검결과
                    txtPECFAULTNM.SetValue(DataSet.Tables[0].Rows[0]["PECFAULTNM"]);
                    txtPECIMPROVE.SetValue(DataSet.Tables[0].Rows[0]["PECIMPROVE"]);
        ...
        function fn_Dataset_Common(sSABUN1, sDATE1,
            ...
            PageMethods.InvokeServiceTable(ht, "PSM.PSM4090", "UP_Get_Ds_Common", function (e) {
        ...
        function fn_RETRACT_Proc() {
            ...
            // 작업요청서 철회
            PageMethods.InvokeServiceTable(ht, "PSM.PSM4090", "UP_EXAM_CHECK_RETRACT", function (e) {
        ...
        function fn_CANCEL_Proc() {
            ...
            PageMethods.InvokeServiceTable(ht, "PSM.PSM4090", "UP_EXAM_CHECK_RUN", function (e) {
                ...
                if (ObjectCount(DataSet.Tables[0].Rows) > 0) {
                    ...
                    // 작업요청서 취소
                    PageMethods.InvokeServiceTable(ht, "PSM.PSM4090", "UP_EXAM_CHECK_CANCEL", function (e) {
                        ...
                        if (ObjectCount(DataSet.Tables[0].Rows) == 1) {
                            ...
                            if (DataSet.Tables[0].Rows[0]["STATE"] == "OK") {
                                ...
                                ////alert('<Ctl:Text runat="server" LangCode="btnSearch_MSG20" Description="탱크 저장물질 변경 가동전 점검 취소 처리가 되었습니다." Literal="true"></Ctl:Text>');

                                //fn_Btn_Visible('3');
                            }
                            else {
                                alert('<Ctl:Text runat="server" LangCode="btnSearch_MSG20" Description="탱크 저장물질 변경 가동전 점검 취소 처리중 오류가 발생하였습니다." Literal="true"></Ctl:Text>');
                                doDisplay();
                            }
                        }
        ...
        function fn_Screen_Save(sGubun, sFinish) {
            ...
            if (sGubun == "SAVE" || sGubun == "APPROVAL") {
                if (svPECTANKNO.GetValue() == "") {
                    alert('<Ctl:Text runat="server" Description="탱크번호를 입력하세요." Literal="true"></Ctl:Text>');
                    doDisplay();
                    return false;
                }
                if (txtPECTITLE.GetValue() == "") {
                    alert('<Ctl:Text runat="server" Description="변경저장물질을 입력하세요." Literal="true"></Ctl:Text>');
                    doDisplay();
                    return false;
                }
                if (txtPECINSDATE.GetValue() == "") {
                    alert('<Ctl:Text runat="server" Description="검토일자를 입력하세요." Literal="true"></Ctl:Text>');
                    doDisplay();
                    return false;
                }
            ...
            ht["P_PECTANKNO"] = svPECTANKNO.GetValue();
            ht["P_PECFAULTNM"] = txtPECFAULTNM.GetValue();
            ht["P_PECIMPROVE"] = txtPECIMPROVE.GetValue();
            ...
            PageMethods.InvokeServiceTable(ht, "PSM.PSM4090", "UP_EXAM_CHECK_ADD", function (e) {
                ...
                if (ObjectCount(DataSet.Tables[0].Rows) == 1) {
                    ...
                    if (DataSet.Tables[0].Rows[0]["STATE"] == "OK") {
                        ...
                        if (sGubun == "POPUP") {
                            ...
                            fn_OpenPopCustom("PSM4081.aspx?param=" + param, 1000, 800, param);
                        }
                        ...
                        if (DetailRows != null) {
                            ...
                            if (ObjectCount(DetailRows.Rows) > 0) {
                                ...
                                PageMethods.InvokeServiceTableArray(ht, hts, "PSM.PSM4090", "UP_EXAM_CHECK_DETAIL_ADD", function (e) {
                                        ...
                                        if (DataSet.Tables[0].Rows[0]["STATE"] == "OK") {
                                            ...
                                            if (sGubun.toString() == "APPROVAL") {
                                                ...
                                                fn_APPROVAL_Display(txtPECWOTEAM.GetValue(), txtPECWODATE.GetValue().split("-").join(""), txtPECWOSEQ.GetValue(),
                                                    txtPECTEAM.GetValue(), txtPECDATE.GetValue().split("-").join(""), txtPECSEQ.GetValue(),"", sKBSABUN.toString(), "OK", sFinish);
                                            ...
                                            alert('<Ctl:Text runat="server" Description="저장 처리중 오류가 발생하였습니다." Literal="true"></Ctl:Text>');
                                            doDisplay();
                                        }
                                    }
                                    else {
        ...
        function btnDel_Click() {
            ...
            if (txtPECRSEQ.GetValue() != "") {
                ...
                alert('<Ctl:Text runat="server" Description="탱크 저장물질 변경 가동전 안전점검 보고서 자료가 존재하므로 삭제가 불가합니다." Literal="true"></Ctl:Text>');
            ...
            if (confirm('<Ctl:Text runat="server" Description="삭제 하시겠습니까?" Literal="true"></Ctl:Text>') == true) {
                ...
                PageMethods.InvokeServiceTable(ht, "PSM.PSM4090", "UP_EXAM_CHECK_DEL", function (e) {
        ...
        function btnPrt_Click() {
            ...
            fn_OpenPop("../../Common/ReportView.aspx?RPT=PSM4091_RPT&PECTEAM=" + txtPECTEAM.GetValue() + "&PECDATE=" + txtPECDATE.GetValue().split("-").join("") +
        ...
        function btnPopup_Click(gubn) {
            ...
            if (gubn == "1") {
                _id = "CODEHELP";
                fn_OpenPopCustom("PSM4071.aspx?param=CHK&param2=2", 1400, 800, "Excon");
            }
            else {

                if (txtPECSEQ.GetValue() == "") {

                    fn_Screen_Save("POPUP", "");
                }
                else {
                    var param = txtPECTEAM.GetValue() + "^" + txtPECDATE.GetValue().split("-").join("") + "^" + txtPECSEQ.GetValue() + "^" + txtPECRDATE.GetValue().split("-").join("") + "^" + txtPECRSEQ.GetValue() + "^" + txtPECTEAMNM.GetValue();
        ...
        function fn_FINISH_UPT() {
            ...
            ht["P_WOFINISHTEXT"] = "탱크 저장물질 변경 가동전 점검 완료";
            ht["P_WOORTEAM"] = txtPECWOTEAM.GetValue();
            ht["P_WOORDATE"] = txtPECWODATE.GetValue().split("-").join("");
            ...
            PageMethods.InvokeServiceTable(ht, "PSM.PSM4090", "UP_WORKORDER_FINISH_UPT", function (e) {
        ...
        function fn_Mail_Send(sPECWOTEAM, sPECWODATE, sPECWOSEQ, sPECTEAM, sPECDATE, sPECSEQ, sPECCANCELCOMMENT, sMail_Receiver, sGUBUN, sFinish) {
            ...
            if (sGUBUN == 'OK') {
                ...
                if (sFinish == "FINISH") {
                    sTitle = txtPECTITLE.GetValue() + " - 탱크 저장물질 변경 가동전 점검 완료";
                }
                else {
                    sTitle = txtPECTITLE.GetValue() + " - 탱크 저장물질 변경 가동전 점검 제출";
                }
            }
            else {
                sTitle = txtPECTITLE.GetValue() + " - 탱크 저장물질 변경 가동전 점검 취소";
            }
            ...
            PageMethods.InvokeServiceTable(ht1, "PSM.PSM4090", "UP_Get_Mail_List", function (e) {
                ...
                if (ObjectCount(DataSet1.Tables[0].Rows) > 0) {
                    ...
                    if (sGUBUN == "OK") {
                        ...
                        alert('<Ctl:Text runat="server" Description="탱크 저장물질 변경 가동전 점검 취소 처리가 되었습니다." Literal="true"></Ctl:Text>');
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="conBody">
    ...
    <div id="content">
		<!-- 레이어 영역시작 -->
        <Ctl:Layer ID="layer1" runat="server" Title="탱크 저장물질 변경 가동전 안전점검표" DefaultHide="False">
            ...
            <div class="btn_bx" style="padding-top:5px;">
		        <table class="table_01" style="width:100%;" border="0">
                    ...
                    <tr>
                        <td style="text-align:center">
                            <Ctl:Text ID="lblPECTANKNO" runat="server" LangCode="lblPECTANKNO" Description="탱크번호" ></Ctl:Text>
                        </td>
                        <td style="text-align:left;">
                            <Ctl:SearchView ID="svPECTANKNO" runat="server" Style="width:80px;" TypeName="PSM.PSMBiz" MethodName="UP_TANKNO_LIST">
							    <Ctl:SearchViewField DataField="TNTANKNO" TextField="탱크"   Description="탱크"   ControlName="TANKID"   Hidden="false" Width="80" TextBox="true"  Default="true" runat="server" />
						    </Ctl:SearchView>
                        </td>
                        <td style="text-align:center">
                            <Ctl:Text ID="lblPECTITLE" runat="server" LangCode="lblPECTITLE" Description="변경저장 물질" ></Ctl:Text>
                        </td>
                    ...
                    <tr>
                        <td style="text-align:center">
                            <Ctl:Text ID="lblPECINSDATE" runat="server" LangCode="lblPECINSDATE" Description="검토일자" ></Ctl:Text>
                        </td>
                        <td style="text-align:left">
                        ...
                        <td style="text-align:left">
                            <Ctl:Combo ID="cboPECSGUBUN" Width="100%" runat="server">
                                ...
                                <asp:ListItem Text="화물" Value="2" Selected="True"></asp:ListItem>
                            </Ctl:Combo>
                        </td>
                        <td style="text-align:center">
            ...
            <table style="width:100%;">
                ...
                <tr>
                    <td valign="top">
                        <Ctl:WebSheet ID="gridDetail" runat="server" Paging="false" CheckBox="false" Width="100%" HFixation="true" Height="365" TypeName="PSM.PSM4090" MethodName="UP_GET_EXAM_CHECK_DETAIL_LIST" UseColumnSort="false" HeaderHeight="20" CellHeight="20">
            ...
            <div class="btn_bx" style="padding-top:5px;padding-bottom:0px;">
		        <table class="table_01" style="width:100%;" border="0">
                    <colgroup>
                        <col width="150px" />
                        <col width="*" />
                    ...
                    <tr>
                        <th colspan="2" style="text-align:left">
                            <Ctl:Text ID="Text10" runat="server" LangCode="Text10" Description="점검결과"></Ctl:Text>
                        </th>
                    </tr>
                    <tr>
                        <td style="text-align:center">
                            <Ctl:Text ID="lblPECFAULTNM" runat="server" LangCode="lblPECFAULTNM" Description="문제점"></Ctl:Text>
                        </td>

                        <td style="text-align:left;">
                            <Ctl:TextBox ID="txtPECFAULTNM" Width="100%" runat="server" LangCode="txtPECFAULTNM"  ></Ctl:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:center">
                            <Ctl:Text ID="lblPECIMPROVE" runat="server" LangCode="lblPECIMPROVE" Description="개선사항"></Ctl:Text>
                        </td>

                        <td style="text-align:left;">
                            <Ctl:TextBox ID="txtPECIMPROVE" Width="100%" runat="server" LangCode="txtPECIMPROVE"  ></Ctl:TextBox>
                        </td>
                    </tr>
                </table>
            </div>
