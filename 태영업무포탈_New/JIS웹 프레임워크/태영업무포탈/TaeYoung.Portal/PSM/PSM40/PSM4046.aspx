<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PSM4046.aspx.cs" Inherits="TaeYoung.Portal.PSM.PSM40.PSM4046" %>
...
<asp:content id="HeaderContent" runat="server" contentplaceholderid="conHead">
    ...
    <script type="text/javascript">
        ...
        function OnLoad() {
            ...
            txtJSDWKGUBN.SetValue(data[4]);
            txtJSDPOTEAM.SetValue(data[5]);
            txtJSDPODATE.SetValue(data[6]);
            txtJSDPOSEQ.SetValue(data[7]);
            txtJSDDATE.SetValue(data[8]);
            txtJSDMSEQ.SetValue(data[9]);
            ...
            ht["P_JSDBLASS"] = txtJSDBLASS.GetValue();
            ht["P_JSDMLASS"] = txtJSDMLASS.GetValue();
            ht["P_JSDSLASS"] = txtJSDSLASS.GetValue();
            ht["P_JSDSEQ"] = txtJSDSEQ.GetValue();
            ...
            if (data.length == 11) {
                DataGubn = "";
                txtJSDITEMSEQ.SetValue(data[10]);
                UP_DataBind_Run();
            }
            else {
                btnNew_Click();
        ...
        function UP_DataMastaBind() {
            ...
            ht["P_JSMWKGUBN"] = txtJSDWKGUBN.GetValue();
            ht["P_JSMPOTEAM"] = txtJSDPOTEAM.GetValue();
            ht["P_JSMPODATE"] = txtJSDPODATE.GetValue();
            ht["P_JSMPOSEQ"] = txtJSDPOSEQ.GetValue();
            ht["P_JSMDATE"] = txtJSDDATE.GetValue();
            ht["P_JSMMSEQ"] = txtJSDMSEQ.GetValue();
            ht["P_JSMBLASS"] = txtJSDBLASS.GetValue();
            ht["P_JSMMLASS"] = txtJSDMLASS.GetValue();
            ht["P_JSMSLASS"] = txtJSDSLASS.GetValue();
            ht["P_JSMSEQ"] = txtJSDSEQ.GetValue();
            ht["P_GUBUN"] = "S";
        ...
        function UP_DataBind_Run() {
            ...
            if (txtJSDITEMSEQ.GetValue() != "") {
                ...
                ht["P_JSDSLASS"] = txtJSDSLASS.GetValue();
                ht["P_JSDSEQ"] = txtJSDSEQ.GetValue();
                ht["P_JSDITEMSEQ"] = txtJSDITEMSEQ.GetValue();
        ...
        function btnSave_Click() {         
            ...
            if (txtJSDBLASS.GetValue() != "" && txtJSDMLASS.GetValue() != "" && txtJSDSLASS.GetValue() != "" && lblJSDSEQ.GetValue() != "") {
                ...
                ht["P_JSDITEMTEXT"] = txtJSDITEMTEXT.GetValue();
                ht["P_JSDTOOLTEXT"] = txtJSDTOOLTEXT.GetValue();

                if (confirm('<Ctl:Text runat="server" Description="저장 하시겠습니까?" Literal="true"></Ctl:Text>') == true) {

                    PageMethods.InvokeServiceTable(ht, "PSM.PSM4045", "UP_JSACHANGE_DETAIL_ADD", function (e) {
        ...
        function UploadComplete() {
            ...
            fileid = txtJSDWKGUBN.GetValue() + txtJSDPOTEAM.GetValue() + txtJSDPODATE.GetValue() + Set_Fill3(txtJSDPOSEQ.GetValue()) + txtJSDDATE.GetValue() + Set_Fill3(txtJSDMSEQ.GetValue());
            fileid = fileid + txtJSDBLASS.GetValue() + txtJSDMLASS.GetValue() + txtJSDSLASS.GetValue() + Set_Fill3(txtJSDSEQ.GetValue()) + Set_Fill3(txtJSDITEMSEQ.GetValue());
        ...
        function btnDel_Click() {
            ...
            if (confirm('<Ctl:Text runat="server" Description="삭제 하시겠습니까?" Literal="true"></Ctl:Text>') == true) {
                ...
                PageMethods.InvokeServiceTable(ht, "PSM.PSM4045", "UP_JSACHANGE_DETAIL_DEL", function (e) {
   ...
   <!--타이틀시작-->
    ...
    <div id="content">
        ...
        <Ctl:Layer ID="layer1" runat="server">
            ...
            <Ctl:WebSheet ID="gridIndex" runat="server" Paging="false" CheckBox="false" Width="100%" HFixation="true" Height="200" TypeName="PSM.PSM4045" MethodName="UP_JSACHANGE_DETAIL_LIST" UseColumnSort="true" HeaderHeight="20" CellHeight="20">
