<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PSM2010.aspx.cs" Inherits="TaeYoung.Portal.PSM.PSM20.PSM2010" %>
...
<asp:content id="HeaderContent" runat="server" contentplaceholderid="conHead">
    ...
    <script type="text/javascript">
        ...
        function btnNew_Click() {
            ...
            fn_OpenPopCustom("PSM2011.aspx?CODE=" + CODE, 800, 680, CODE);
        }
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="conBody">  
    ...
    <!--컨텐츠시작-->
    <div id="content">
        <Ctl:Layer ID="layer1" runat="server" Title="공정안전자료" DefaultHide="False">
        <table style="width: 100%;">
                ...
                <tr>
                    <td valign="top">
                        <div class="btn_bx" style="height:760px; overflow-y:hidden; overflow-x:hidden; ">
                            <table class="table_01" style="width:100%;height:100%;">    
                                ...
                                <tr>
                                    <td style="text-align:left;">
                                        <div style="height:740px;width:220px; overflow-y:auto; overflow-x:auto;" >
                                        <Ctl:WebTree ID="wtBoardlist" runat="server" CheckBox="false" Description="공정안전자료관리" HideTitle="false" IndexBindFiledName="MENU_NO" EnableSearchBox="false"
                            ...
                            <table class="table_01" style="width: 100%;">    
                                ...
                                <tr>
                                    <td colspan="7" style="text-align:left;border:none;">
                                        <div>
                                            <Ctl:Text ID="txtPBMLCODEPL" runat="server" LangCode="txtPBMLCODEPL" Description="공정안전자료관리"></Ctl:Text>
                                        </div>
                                    </td>
                                </tr>
                                <tr >
