<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PSM3010.aspx.cs" Inherits="TaeYoung.Portal.PSM.PSM30.PSM3010" %>
...
<asp:content id="HeaderContent" runat="server" contentplaceholderid="conHead">
    ...
    <script type="text/javascript">
        ...
        function btnNew_Click() {
            ...
            fn_OpenPopCustom("PSM3011.aspx?CODE=" + CODE, 800, 680, CODE);
        }
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="conBody">  
    ...
    <!--컨텐츠시작-->
    <div id="content">
        <Ctl:Layer ID="layer1" runat="server" Title="위험성평가" DefaultHide="False">
                            ...
                            <table class="table_01" style="width:100%;height:100%;">    
                                ...
                                <tr>
                                    <td style="text-align:left;">
                                        ...
                                        <Ctl:WebTree ID="wtBoardlist" runat="server" CheckBox="false" Description="위험성평가관리" HideTitle="false" IndexBindFiledName="MENU_NO" EnableSearchBox="false"
                            ...
                            <table class="table_01" style="width: 100%;">    
                                ...
                                <tr>
                                    <td colspan="7" style="text-align:left;border:none;">
                                        <div>
                                            <Ctl:Text ID="txtPBMLCODEPL" runat="server" LangCode="txtPBMLCODEPL" Description="위험성평가관리"></Ctl:Text>
                                        </div>
                                    </td>
                                </tr>
                                <tr >
