<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CSI1030.aspx.cs" Inherits="TaeYoung.Portal.TYCSI.CSI.CSI1030" %>
...
<asp:content id="HeaderContent" runat="server" contentplaceholderid="conHead">
    <script type="text/javascript">
        ...
        function btnPrint_Click() {
            ...
            fn_OpenPop("../../Common/ReportView.aspx?RPT=CSI1030_RPT&Date=" + txtDate.GetValue(), 500, 500);
        }

        function btnExcel_Click() {

            if (txtSearchDate.GetValue() == "") {
                alert('<Ctl:Text runat="server" LangCode="btnSearch_MSG01" Description="재고일자를 입력 하세요." Literal="true"></Ctl:Text>');
                return false;
            }
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="conBody">
   <div id="content">
        <Ctl:Layer ID="layer1" runat="server" Title="입고화물별 재고조회" DefaultHide="False" LangCode="layer1" Description="입고화물별 재고조회">
        <div class="btn_bx">        
            <table class="table_01" style="width: 100%;">    
              ...
              <Ctl:WebSheet ID="gridIndex" runat="server" Paging="true" HFixation="true" Fixation = "true" Height="650" CheckBox="false" Width="100%" TypeName="CSI.CSIBiz" MethodName="UP_CSI1030_LIST" UseColumnSort="true" HeaderHeight="20" CellHeight="30" >
                        ...
                        <Ctl:SheetField DataField="VSDESC1" TextField="VSDESC1" Description="본  선" Width="130" HAlign="center" Align="left" runat="server" AutoMerge="true" />                            
                        <Ctl:SheetField DataField="HJDESC1" TextField="HJDESC1" Description="통관화주" Width="130" HAlign="center" Align="left" runat="server" AutoMerge="true" />        
                        ...
                        <Ctl:SheetField DataField="IPHSNSEQ" TextField="IPHSNSEQ" Description="HSN" Width="60" HAlign="center" Align="center" runat="server" AutoMerge="true" />                                                       
