<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AM103010.aspx.cs" Inherits="TaeYoung.Portal.Admin.Cmn.AM103010" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="conBody">
    ...
    <div id="title">
        <h4>
            <Ctl:Text ID="TXT01" runat="server" LangCode="TXT01" Description="사용자 조회" Literal="true"></Ctl:Text>
        </h4>    
        <div class="btn_bx">
