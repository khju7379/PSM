<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CSG1040.aspx.cs" Inherits="TaeYoung.Portal.TGCSI.CSI.CSG1040" %>
...
<asp:content id="HeaderContent" runat="server" contentplaceholderid="conHead">
    <script type="text/javascript">
        ...
        function btnPrint_Click() {
            ...
            fn_OpenPop("../../Common/ReportView.aspx?RPT=CSG1040_RPT&Date_Fr=" + txtFRDate.GetValue() + "&Date_To=" + txtTODate.GetValue(), 500, 500);
        }        
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="conBody">
   <div id="content">
        <Ctl:Layer ID="layer1" runat="server" Title="일자별 출고 조회" DefaultHide="False" LangCode="layer1" Description="일자별 출고 조회">
            ...
            <Ctl:WebSheet ID="gridIndex" runat="server" Paging="true" HFixation="true" Fixation="true" Height="600" CheckBox="false" Width="100%" TypeName="CSG.CSGBiz" MethodName="UP_CSG1040_LIST" UseColumnSort="true" HeaderHeight="20" CellHeight="30" >
                <Ctl:SheetField DataField="COMPANY"    TextField="COMPANY"    Description="회사"         Width="140"  HAlign="left"  Align="left"  runat="server" AutoMerge="true" />
                <Ctl:SheetField DataField="GKDESC1"    TextField="GKDESC1"    Description="곡종"         Width="160"  HAlign="left"  Align="left"  runat="server" AutoMerge="true" />
                <Ctl:SheetField DataField="VSDESC1"    TextField="VSDESC1"    Description="모선"         Width="160"  HAlign="left"  Align="left"  runat="server" AutoMerge="true" />
                <Ctl:SheetField DataField="CHBLNO"     TextField="CHBLNO"     Description="B/L번호"      Width="160"  HAlign="left"  Align="left"  runat="server" AutoMerge="true" />
                ...
                <Ctl:SheetField DataField="CHSEQ"      TextField="CHSEQ"      Description="차수"         Width="70"   HAlign="left"  Align="left"  runat="server" />
                ...
                <Ctl:SheetField DataField="CHTIME"     TextField="CHTIME"     Description="입출문시간"   Width="110"  HAlign="left"  Align="left"  runat="server" />
                <Ctl:SheetField DataField="CHNUMBER"   TextField="CHNUMBER"   Description="차량"         Width="110"  HAlign="left"  Align="left"  runat="server" />
                <Ctl:SheetField DataField="HJDESC1"    TextField="HJDESC1"    Description="양도화주"     Width="160"  HAlign="left"  Align="left"  runat="server" />
            </Ctl:WebSheet>
        </Ctl:Layer> 
    </div>
</asp:content>