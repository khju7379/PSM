...
<root>
    ...
    <ui seq="3">
		<tab id="tab01" img="org_btbg02" type="approveragree">
			...
			<list id="approval" type="normal">
				<lstitle>
                    <Ctl:Text runat="server" ID="Text37" LangCode="LTITLE01" Description="결재자" Literal="true"/>
                ...
                <ritem id="r3006" seq="3" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text5" LangCode="C_R_EXA_TITLE6" Description="검토6" Literal="true"/></ritem>
                <ritem id="r3005" seq="3" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text6" LangCode="C_R_EXA_TITLE5" Description="검토5" Literal="true"/></ritem>
                <ritem id="r3004" seq="3" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text16" LangCode="C_R_EXA_TITLE4" Description="검토4" Literal="true"/></ritem>
                <ritem id="r3003" seq="3" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text17" LangCode="C_R_EXA_TITLE3" Description="검토3" Literal="true"/></ritem>
                <ritem id="r3002" seq="3" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text34" LangCode="C_R_EXA_TITLE2" Description="검토2" Literal="true"/></ritem>
				<ritem id="r3001" seq="3" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text35" LangCode="C_R_EXA_TITLE1" Description="검토1" Literal="true"/></ritem>
				<ritem id="emp3" seq="3" disabled="true" change="true" validation="true"><Ctl:Text runat="server" ID="Text36" LangCode="C_R_EMP_TITLE2" Description="담당" Literal="true"/></ritem>
			</list>
            <list id="multi" type="agree">
