...
<root>
	...
	<ui seq="0">
		<tab id="tab01" img="org_btbg02" type="approveragree">
			...
			<list id="approval_0" type="normal">
                ...
                <ritem id="r0003" seq="0" disabled="true" change="true" validation="fasle"><asp:literal runat="server" text="<%$ Resources:WebOrg, C_R_EXA_TITLE %>"/></ritem>
	...
	<ui seq="1">
		<tab id="tab01" img="org_btbg02" type="charge">
			...
			<list id="charge" type="normal">
				<lstitle><asp:literal runat="server" text="<%$ Resources:WebOrg, C_LS_TITLE1 %>"/></lstitle>
				<ritem id="app1" seq="1" disabled="true" change="true" validation="false"><asp:literal runat="server" text="<%$ Resources:WebOrg, C_R_APP_TITLE1 %>"/></ritem>
                <ritem id="r1003" seq="1" disabled="true" change="true" validation="false"><asp:literal runat="server" text="<%$ Resources:WebOrg, C_R_EXA_TITLE %>"/></ritem>
