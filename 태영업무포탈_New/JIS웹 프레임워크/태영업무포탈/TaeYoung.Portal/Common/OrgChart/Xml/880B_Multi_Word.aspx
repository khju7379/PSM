...
<root>
	...
	<ui seq="0">
		<tab id="tab01" img="org_btbg02" type="approveragree">
		    <tbtitle>
                <Ctl:Text runat="server" ID="tC_TB_TITLE1" LangCode="ZZZZ" Description="현법인결재선" Literal="true"/>
            </tbtitle>
        ...
        <tab id="tab02" img="org_btbg01" type="chargeagree">
			<tbtitle>
                <Ctl:Text runat="server" ID="Text28" LangCode="C_TB_TITLE4" Description="본사결재선" Literal="true" />
            </tbtitle>
			<list id="approval" type="normal" size="1">
				<lstitle>
                    <Ctl:Text runat="server" ID="Text19" LangCode="LTITLE01" Description="결재자" Literal="true"/>
                    <%--<Ctl:Text runat="server" ID="Text29" LangCode="C_TB_TITLE4" Description="결재자" Literal="true" />--%>
                </lstitle>
                <ritem id="app1" seq="1" disabled="true" change="true" validation="true"><Ctl:Text runat="server" ID="Text1" LangCode="C_R_APP_TITLE1" Description="승인" Literal="true"/></ritem>
                <ritem id="r1006" seq="1" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text2" LangCode="C_R_EXA_TITLE6" Description="검토6" Literal="true"/></ritem>
                <ritem id="r1005" seq="1" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text3" LangCode="C_R_EXA_TITLE5" Description="검토5" Literal="true"/></ritem>
                <ritem id="r1004" seq="1" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text14" LangCode="C_R_EXA_TITLE4" Description="검토4" Literal="true"/></ritem>
                <ritem id="r1003" seq="1" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text15" LangCode="C_R_EXA_TITLE3" Description="검토3" Literal="true"/></ritem>
                <ritem id="r1002" seq="1" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text16" LangCode="C_R_EXA_TITLE2" Description="검토2" Literal="true"/></ritem>
				<ritem id="r1001" seq="1" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text17" LangCode="C_R_EXA_TITLE1" Description="검토1" Literal="true"/></ritem>
				<ritem id="emp1" seq="1" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text18" LangCode="C_R_EMP_TITLE2" Description="담당" Literal="true"/></ritem>
			</list>
            <list id="multi" type="agree">
    ...
    <ui seq="1">
		<tab id="tab01" img="org_btbg02" type="approveragree">
			<tbtitle>
                <Ctl:Text runat="server" ID="Text13" LangCode="TTILE02" Description="발신" Literal="true"/>
                <%--<Ctl:Text runat="server" ID="Text12" LangCode="C_TB_TITLE3" Description="결재자" Literal="true"/>--%>
            </tbtitle>
			<list id="approval" type="normal">
				<lstitle>
                    <Ctl:Text runat="server" ID="Text20" LangCode="LTITLE01" Description="결재자" Literal="true"/>
            ...
            <list id="multi" type="agree">
				...
				<tab id="r1002" seq="2" img="org_btbg01"><tbtitle>검토2후협조</tbtitle></tab>
				<tab id="r1003" seq="3" img="org_btbg01"><tbtitle>검토3후협조</tbtitle></tab>
                <tab id="r1003" seq="4" img="org_btbg01"><tbtitle>검토4후협조</tbtitle></tab>
                <tab id="r1003" seq="5" img="org_btbg01"><tbtitle>검토5후협조</tbtitle></tab>
                <tab id="r1003" seq="6" img="org_btbg01"><tbtitle>검토6후협조</tbtitle></tab>
				<item id="emp1_after" type="agree" min="0" max="0" size="5">
					<lstitle><asp:literal runat="server" text=""/></lstitle>
				</item>
				<item id="r1001_after" type="agree" min="0" max="0" size="5">
