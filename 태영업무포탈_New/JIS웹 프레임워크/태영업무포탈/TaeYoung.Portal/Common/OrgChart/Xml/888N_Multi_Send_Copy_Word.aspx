...
<root>
	...
	<ui seq="0">
        ...
        <tab id="tab03" img="org_btbg01" type="acl">
			...
			<%--<tbtitle><Ctl:Text runat="server" ID="Text34" LangCode="C_TB_TITLE2" Description="수신처/사본처" Literal="true"/></tbtitle>--%>
    ...
    <ui seq="1">
		<tab id="tab01" img="org_btbg02" type="approveragree">
			...
			<list id="approval" type="normal">
				<lstitle>
                    <Ctl:Text runat="server" ID="Text28" LangCode="LTITLE01" Description="결재자" Literal="true"/>
        ...
        <tab id="tab02" img="org_btbg01" type="charge">
			...
			<list id="charge" type="normal" size="1">
				...
				<ritem id="emp2" seq="2" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text33" LangCode="C_R_EMP_TITLE2" Description="담당" Literal="true" /></ritem>
			</list>
		</tab>
	</ui>
    <ui seq="2">
