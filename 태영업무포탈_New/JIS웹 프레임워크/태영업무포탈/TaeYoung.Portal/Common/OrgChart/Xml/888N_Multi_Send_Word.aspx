...
<root>
	...
	<ui seq="0">
		<tab id="tab01" img="org_btbg02" type="approveragree">
			...
			<list id="approval" type="normal">
                ...
                <ritem id="app0" seq="0" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="tC_R_APP_TITLE1" LangCode="ORG_C_R_APP_TITLE1" Description="승인" Literal="true"/></ritem>
    ...
    <ui seq="1">
        ...
        <tab id="tab02" img="org_btbg01" type="charge">
			<tbtitle>
                <Ctl:Text runat="server" ID="Text19" LangCode="TTILE03" Description="수신" Literal="true"/>
