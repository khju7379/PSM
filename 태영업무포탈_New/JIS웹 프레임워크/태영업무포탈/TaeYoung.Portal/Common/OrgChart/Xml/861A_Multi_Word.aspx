...
<root>
    ...
    <ui seq="0">
		<tab id="tab01" img="org_btbg02" type="approveragree">
			<tbtitle>
                ...
                <%--<Ctl:Text runat="server" ID="Text18" LangCode="C_TB_TITLE3" Description="발신 및 협조" Literal="true"/>--%>
            </tbtitle>
			<list id="approval" type="normal">
				...
				<ritem id="app0" seq="0" disabled="true" change="true" validation="true"><Ctl:Text runat="server" ID="Text20" LangCode="C_R_APP_TITLE1" Description="승인" Literal="true"/></ritem>
                <ritem id="r0006" seq="0" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text21" LangCode="C_R_EXA_TITLE6" Description="검토6" Literal="true"/></ritem>
                <ritem id="r0005" seq="0" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text22" LangCode="C_R_EXA_TITLE5" Description="검토5" Literal="true"/></ritem>
                <ritem id="r0004" seq="0" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text23" LangCode="C_R_EXA_TITLE4" Description="검토4" Literal="true"/></ritem>
                <ritem id="r0003" seq="0" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text24" LangCode="C_R_EXA_TITLE3" Description="검토3" Literal="true"/></ritem>
                <ritem id="r0002" seq="0" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text25" LangCode="C_R_EXA_TITLE2" Description="검토2" Literal="true"/></ritem>
				<ritem id="r0001" seq="0" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text26" LangCode="C_R_EXA_TITLE1" Description="검토1" Literal="true"/></ritem>
				<ritem id="emp0" seq="0" disabled="true" change="false" validation="true"><Ctl:Text runat="server" ID="Text27" LangCode="C_R_EMP_TITLE2" Description="담당" Literal="true"/></ritem>
			</list>
            <list id="multi" type="agree">
                ...
                <tab id="r0004" seq="4" img="org_btbg01"><tbtitle>검토4후협조</tbtitle></tab>
                <tab id="r0005" seq="5" img="org_btbg01"><tbtitle>검토5후협조</tbtitle></tab>
                <tab id="r0006" seq="6" img="org_btbg01"><tbtitle>검토6후협조</tbtitle></tab>
    ...
    <ui seq="1">
		<tab id="tab01" img="org_btbg02" type="approveragree">
			...
			<list id="approval" type="normal">
				...
				<ritem id="r1005" seq="1" disabled="true" change="true" validation="true"><Ctl:Text runat="server" ID="Text4" LangCode="C_R_APP_TITLE1" Description="승인" Literal="true"/></ritem>
            ...
            <list id="multi" type="agree">
                ...
                <tab id="r1005" seq="5" img="org_btbg01"><tbtitle>승인후협조</tbtitle></tab>
        ...
        <tab id="tab02" img="org_btbg01" type="charge">
			<tbtitle>
                <Ctl:Text runat="server" ID="Text12" LangCode="TTILE03" Description="수신" Literal="true"/>
    ...
    <ui seq="2">
		<tab id="tab01" img="org_btbg02" type="approveragree">
			<tbtitle><Ctl:Text runat="server" ID="Text1" LangCode="C_TB_TITLE3" Description="결재자" Literal="true"/></tbtitle>
			<list id="approval" type="normal">
				<lstitle>
				...
				<ritem id="emp2" seq="2" disabled="true" change="false" validation="true"><Ctl:Text runat="server" ID="Text3" LangCode="C_R_EMP_TITLE2" Description="담당" Literal="true"/></ritem>
			</list>
		</tab>
	</ui>
</root>