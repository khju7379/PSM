...
<root>
	...
	<ui seq="0">
		<tab id="tab02" img="org_btbg01" type="charge">
			<tbtitle>
                <Ctl:Text runat="server" ID="Text2" LangCode="TTILE03" Description="수신" Literal="true"/>
    ...
    <ui seq="1">
        ...
        <tab id="tab02" img="org_btbg01" type="charge">
			<tbtitle>
                <Ctl:Text runat="server" ID="Text6" LangCode="TTILE03" Description="수신" Literal="true"/>
    ...
    <ui seq="2">
		<tab id="tab01" img="org_btbg02" type="approveragree">
			...
			<list id="approval" type="normal">
				<lstitle>
                    <Ctl:Text runat="server" ID="Text8" LangCode="LTITLE01" Description="결재자" Literal="true"/>
