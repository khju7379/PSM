...
<root>
	...
	<ui seq="0">
		<tab id="tab01" img="org_btbg02" type="approveragree">
            ...
            <list id="multi" type="agree">
                ...
                <tab id="r0003" seq="3" img="org_btbg01"><tbtitle>검토4후협조</tbtitle></tab>
                <tab id="r0003" seq="3" img="org_btbg01"><tbtitle>검토5후협조</tbtitle></tab>
                <tab id="r0003" seq="3" img="org_btbg01"><tbtitle>검토6후협조</tbtitle></tab>
    ...
    <ui seq="1">
		<tab id="tab01" img="org_btbg02" type="approveragree">
			<tbtitle>
                <Ctl:Text runat="server" ID="Text16" LangCode="TTILE02" Description="발신" Literal="true"/>
                <%--<Ctl:Text runat="server" ID="Text12" LangCode="C_TB_TITLE3" Description="결재자" Literal="true"/>--%>
            </tbtitle>
			<list id="approval" type="normal">
				<lstitle>
                    <Ctl:Text runat="server" ID="Text17" LangCode="LTITLE01" Description="결재자" Literal="true"/>
            ...
            <list id="multi" type="agree">
                ...
                <tab id="r1005" seq="5" img="org_btbg01"><tbtitle>검토5후협조</tbtitle></tab>
                <tab id="r1006" seq="6" img="org_btbg01"><tbtitle>검토6후협조</tbtitle></tab>
        ...
        <tab id="tab02" img="org_btbg01" type="charge">
			<tbtitle>
                <Ctl:Text runat="server" ID="Text28" LangCode="TTILE03" Description="수신" Literal="true"/>
    ...
    <ui seq="2">
		<tab id="tab01" img="org_btbg02" type="approveragree">
			<tbtitle>
                <Ctl:Text runat="server" ID="Text12" LangCode="TTILE02" Description="발신" Literal="true"/>
                <%--<Ctl:Text runat="server" ID="Text18" LangCode="C_TB_TITLE3" Description="결재자" Literal="true"/>--%>
            </tbtitle>
			<list id="approval" type="normal">
				<lstitle>
                    <Ctl:Text runat="server" ID="Text29" LangCode="LTITLE01" Description="결재자" Literal="true"/>
        ...
        <tab id="tab02" img="org_btbg01" type="charge">
			<tbtitle>
                <Ctl:Text runat="server" ID="Text31" LangCode="TTILE03" Description="수신" Literal="true"/>
                <%--<Ctl:Text runat="server" ID="Text41" LangCode="C_TB_TITLE4" Description="담당자" Literal="true" />--%>
            </tbtitle>
			<list id="charge" type="normal" size="1">
				<lstitle>
                    <Ctl:Text runat="server" ID="Text19" LangCode="LTITLE01" Description="결재자" Literal="true"/>
                    <%--<Ctl:Text runat="server" ID="Text42" LangCode="C_TB_TITLE4" Description="담당자" Literal="true" />--%>
                </lstitle>
				<ritem id="emp3" seq="3" disabled="true" change="true" validation="true"><Ctl:Text runat="server" ID="Text43" LangCode="C_R_EMP_TITLE2" Description="담당" Literal="true" /></ritem>
			</list>
		</tab>
	</ui>
    <ui seq="3">
		<tab id="tab01" img="org_btbg02" type="approveragree">
			<tbtitle>
                <Ctl:Text runat="server" ID="Text18" LangCode="TTILE02" Description="발신" Literal="true"/>
                <%--<Ctl:Text runat="server" ID="Text1" LangCode="C_TB_TITLE3" Description="결재자" Literal="true"/>--%>
            </tbtitle>
			<list id="approval" type="normal">
				<lstitle>
                    <Ctl:Text runat="server" ID="Text32" LangCode="LTITLE01" Description="결재자" Literal="true"/>
                    <%--<Ctl:Text runat="server" ID="Text2" LangCode="C_LS_TITLE1" Description="담당자" Literal="true"/>--%>
                </lstitle>
				<ritem id="app3" seq="3" disabled="true" change="true" validation="fasle"><Ctl:Text runat="server" ID="Text3" LangCode="C_R_APP_TITLE1" Description="승인" Literal="true"/></ritem>
                <ritem id="r3006" seq="3" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text34" LangCode="C_R_EXA_TITLE6" Description="검토6" Literal="true"/></ritem>
                <ritem id="r3005" seq="3" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text35" LangCode="C_R_EXA_TITLE5" Description="검토5" Literal="true"/></ritem>
                <ritem id="r3004" seq="3" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text36" LangCode="C_R_EXA_TITLE4" Description="검토4" Literal="true"/></ritem>
                <ritem id="r3003" seq="3" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text37" LangCode="C_R_EXA_TITLE3" Description="검토3" Literal="true"/></ritem>
                <ritem id="r3002" seq="3" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text38" LangCode="C_R_EXA_TITLE2" Description="검토2" Literal="true"/></ritem>
				<ritem id="r3001" seq="3" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text39" LangCode="C_R_EXA_TITLE1" Description="검토1" Literal="true"/></ritem>
				<ritem id="emp3" seq="3" disabled="true" change="false" validation="true"><Ctl:Text runat="server" ID="Text40" LangCode="C_R_EMP_TITLE2" Description="담당" Literal="true"/></ritem>
			</list>
            <list id="multi" type="agree">
