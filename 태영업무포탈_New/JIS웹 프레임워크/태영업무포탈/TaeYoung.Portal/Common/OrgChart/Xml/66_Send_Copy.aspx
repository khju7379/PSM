	...
	<ui seq="0">
		<tab id="tab01" img="org_btbg02" type="approveragree">
			...
			<list id="approval_0" type="normal">
				...
				<ritem id="app0" seq="0" disabled="true" change="true" validation="fasle"><asp:literal runat="server" text="<%$ Resources:WebOrg, C_R_EXA_TITLE5 %>"/></ritem>
            ...
            <list id="charge" type="normal">
				<lstitle><asp:literal runat="server" text="<%$ Resources:WebOrg, C_LS_TITLE11 %>"/></lstitle>
                ...
                <ritem id="r1004" seq="1" disabled="true" change="true" validation="fasle"><asp:literal runat="server" text="<%$ Resources:WebOrg, C_R_EXA_TITLE5 %>"/></ritem>
                <ritem id="r1003" seq="1" disabled="true" change="true" validation="fasle"><asp:literal runat="server" text="<%$ Resources:WebOrg, C_R_EXA_TITLE4 %>"/></ritem>
				<ritem id="r1002" seq="1" disabled="true" change="true" validation="fasle"><asp:literal runat="server" text="<%$ Resources:WebOrg, C_R_EXA_TITLE3 %>"/></ritem>
                <ritem id="r1001" seq="1" disabled="true" change="true" validation="fasle"><asp:literal runat="server" text="<%$ Resources:WebOrg, C_R_EXA_TITLE2 %>"/></ritem>
				<ritem id="emp1" seq="1" disabled="true" change="true" validation="true"><asp:literal runat="server" text="<%$ Resources:WebOrg, C_R_EXA_TITLE1 %>"/></ritem>
			</list>
		</tab>
	...
	<ui seq="1">
		<tab id="tab01" img="org_btbg02" type="charge">
			...
			<list id="charge" type="normal">
				<lstitle><asp:literal runat="server" text="<%$ Resources:WebOrg, C_LS_TITLE1 %>"/></lstitle>
				<ritem id="app1" seq="1" disabled="true" change="true" validation="true"><asp:literal runat="server" text="<%$ Resources:WebOrg, C_R_APP_TITLE1 %>"/></ritem>
                <ritem id="r1004" seq="1" disabled="true" change="true" validation="false"><asp:literal runat="server" text="<%$ Resources:WebOrg, C_R_EXA_TITLE5 %>"/></ritem>
                <ritem id="r1003" seq="1" disabled="true" change="true" validation="false"><asp:literal runat="server" text="<%$ Resources:WebOrg, C_R_EXA_TITLE4 %>"/></ritem>
				<ritem id="r1002" seq="1" disabled="true" change="true" validation="false"><asp:literal runat="server" text="<%$ Resources:WebOrg, C_R_EXA_TITLE3 %>"/></ritem>
                <ritem id="r1001" seq="1" disabled="true" change="true" validation="false"><asp:literal runat="server" text="<%$ Resources:WebOrg, C_R_EXA_TITLE2 %>"/></ritem>
				<ritem id="emp1" seq="1" disabled="true" change="false" validation="true"><asp:literal runat="server" text="<%$ Resources:WebOrg, C_R_EXA_TITLE1 %>"/></ritem>
			</list>
		</tab>
        <tab id="tab02" img="org_btbg01" type="acl">
			<tbtitle><asp:literal runat="server" text="<%$ Resources:WebOrg, C_TB_TITLE2 %>"/></tbtitle>
