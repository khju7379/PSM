...
<root>
    ...
    <ui seq="1">
        ...
        <tab id="tab02" img="org_btbg01" type="charge">
			<tbtitle>
                <Ctl:Text runat="server" ID="Text3" LangCode="TTILE03" Description="수신" Literal="true"/>
                <%--<Ctl:Text runat="server" ID="Text31" LangCode="C_TB_TITLE4" Description="담당자" Literal="true" />--%>
            </tbtitle>
			<list id="charge" type="normal" size="1">
				<lstitle>
                    <Ctl:Text runat="server" ID="Text10" LangCode="LTITLE01" Description="결재자" Literal="true"/>
        ...
        <tab id="tab03" img="org_btbg01" type="acl">
			...
			<%--<tbtitle><Ctl:Text runat="server" ID="Text8" LangCode="C_TB_TITLE2" Description="수신처/사본처" Literal="true"/></tbtitle>--%>
    ...
    <ui seq="2">
        ...
        <tab id="tab02" img="org_btbg01" type="charge">
			<tbtitle>
                <Ctl:Text runat="server" ID="Text9" LangCode="TTILE03" Description="수신" Literal="true"/>
