    ...
    <ui seq="2">
		<tab id="tab01" img="org_btbg02" type="approveragree">
			...
			<list id="approval" type="normal">
				...
				<ritem id="r2002" seq="2" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text7" LangCode="C_R_EXA_TITLE1" Description="검토1" Literal="true"/></ritem>
				<ritem id="r2001" seq="2" disabled="true" change="false" validation="true"><Ctl:Text runat="server" ID="Text26" LangCode="C_R_EMP_TITLE2" Description="담당" Literal="true"/></ritem>
			</list>
            <list id="multi" type="agree">
				<tab id="r2002" seq="1" img="org_btbg01"><tbtitle>검토1후협조</tbtitle></tab>
