...
<root>
    ...
    <ui seq="1">
		<tab id="tab01" img="org_btbg02" type="approveragree">
			<tbtitle>
                <Ctl:Text runat="server" ID="Text2" LangCode="TTILE01" Description="발신 및 협조" Literal="true"/>
    ...
    <ui seq="2">
		<tab id="tab01" img="org_btbg02" type="approveragree">
			<tbtitle>
                <Ctl:Text runat="server" ID="Text12" LangCode="TTILE01" Description="발신 및 협조" Literal="true"/>
        ...
        <tab id="tab02" img="org_btbg01" type="charge">
			<tbtitle>
                <Ctl:Text runat="server" ID="Text18" LangCode="TTILE03" Description="수신" Literal="true"/>
    ...
    <ui seq="3">
		<tab id="tab01" img="org_btbg02" type="approveragree">
			...
			<list id="approval" type="normal">
				<lstitle>
                    <Ctl:Text runat="server" ID="Text42" LangCode="LTITLE01" Description="결재자" Literal="true"/>
