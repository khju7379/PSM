...
<root>
    ...
    <ui seq="1">
        ...
        <tab id="tab03" img="org_btbg01" type="acl">
			...
			<%--<tbtitle><Ctl:Text runat="server" ID="Text44" LangCode="C_TB_TITLE2" Description="수신처/사본처" Literal="true"/></tbtitle>--%>
    ...
    <ui seq="2">
		<tab id="tab01" img="org_btbg02" type="approveragree">
			<tbtitle>
                <Ctl:Text runat="server" ID="Text5" LangCode="TTILE01" Description="발신 및 협조" Literal="true"/>
        ...
        <tab id="tab02" img="org_btbg01" type="charge">
			<tbtitle>
                ...
                <%--<Ctl:Text runat="server" ID="Text39" LangCode="C_TB_TITLE4" Description="담당자" Literal="true" />--%>
            </tbtitle>
			<list id="charge" type="normal" size="1">
				<lstitle>
                    <Ctl:Text runat="server" ID="Text19" LangCode="LTITLE01" Description="결재자" Literal="true"/>
                    <%--<Ctl:Text runat="server" ID="Text40" LangCode="C_TB_TITLE4" Description="담당자" Literal="true" />--%>
                </lstitle>
				<ritem id="emp3" seq="3" disabled="true" change="true" validation="true"><Ctl:Text runat="server" ID="Text41" LangCode="C_R_EMP_TITLE2" Description="담당" Literal="true" /></ritem>
			</list>
		</tab>
        <tab id="tab03" img="org_btbg01" type="acl">
			<tbtitle><Ctl:Text runat="server" ID="Text42" LangCode="C_TB_TITLE2" Description="수신처" Literal="true"/></tbtitle>
			<%--<tbtitle><Ctl:Text runat="server" ID="Text44" LangCode="C_TB_TITLE2" Description="수신처/사본처" Literal="true"/></tbtitle>--%>
			<list id="send" type="sendto" min="0" max="0" size="8">
				<lstitle><Ctl:Text runat="server" ID="Text43" LangCode="C_LS_TITLE3" Description="수신처" Literal="true"/></lstitle>
			</list>
		</tab>
	</ui>
    <ui seq="3">
		<tab id="tab01" img="org_btbg02" type="approveragree">
			<tbtitle>
                ...
                <%--<Ctl:Text runat="server" ID="Text3" LangCode="C_TB_TITLE3" Description="결재자" Literal="true"/>--%>
            </tbtitle>
			<list id="approval" type="normal">
				<lstitle>
                    <Ctl:Text runat="server" ID="Text39" LangCode="LTITLE01" Description="결재자" Literal="true"/>
				...
				<ritem id="r3001" seq="3" disabled="true" change="true" validation="false"><Ctl:Text runat="server" ID="Text37" LangCode="C_R_EXA_TITLE1" Description="검토1" Literal="true"/></ritem>
				<ritem id="emp3" seq="3" disabled="true" change="true" validation="true"><Ctl:Text runat="server" ID="Text38" LangCode="C_R_EMP_TITLE2" Description="담당" Literal="true"/></ritem>
			</list>
            <list id="multi" type="agree">
