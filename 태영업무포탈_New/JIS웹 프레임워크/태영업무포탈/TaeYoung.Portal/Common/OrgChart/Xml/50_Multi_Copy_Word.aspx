...
<root>
	...
	<ui seq="0">
		...
		<tab id="tab02" img="org_btbg01" type="acl">
			<tbtitle><asp:literal runat="server" text="<%$ Resources:WebOrg, AppointApprovalInternalCopy %>"/></tbtitle>
			<list id="copy" type="sendto" min="0" max="0" size="8">
				<lstitle><asp:literal runat="server" text="<%$ Resources:WebOrg, AppointApprovalInternalCopy %>"/></lstitle>
			</list>
		</tab>
	</ui>
</root>