	...
	<ui seq="0">
		<tab id="tab01" img="org_btbg02" type="approveragree">
			...
			<list id="multi" type="agree">
				...
				<item id="g0001" type="agree" min="0" max="0" size="5">
					<lstitle><asp:literal runat="server" text=""/></lstitle>
				</item>
				<item id="g0002" type="agree" min="0" max="0" size="5">
					<lstitle><asp:literal runat="server" text=""/></lstitle>
				</item>
				<item id="g0003" type="agree" min="0" max="0" size="5">
					<lstitle><asp:literal runat="server" text=""/></lstitle>
				</item>
				<item id="g0004" type="agree" min="0" max="0" size="5">
					<lstitle><asp:literal runat="server" text=""/></lstitle>
				</item>
			</list>
		</tab>
