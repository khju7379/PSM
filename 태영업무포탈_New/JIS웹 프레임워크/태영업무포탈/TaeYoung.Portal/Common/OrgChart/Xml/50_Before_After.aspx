...
<root>
	...
	<ui seq="0">
		...
		<tbtitle><asp:literal runat="server" text="<%$ Resources:WebOrg, C_TB_TITLE1 %>"/></tbtitle>
			...
			<list id="before" type="agree" min="0" max="0" size="3">
				<lstitle><asp:literal runat="server" text="<%$ Resources:WebOrg, C_LS_TITLE6 %>"/></lstitle>
			</list>
			<list id="after" type="agree" min="0" max="0" size="3">
				<lstitle><asp:literal runat="server" text="<%$ Resources:WebOrg, C_LS_TITLE7 %>"/></lstitle>
			</list>
		</tab>
	</ui>
</root>