<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CSS1060.aspx.cs" Inherits="TaeYoung.Portal.TYCSS.CSS.CSS1060" %>
...
<asp:content id="HeaderContent" runat="server" contentplaceholderid="conHead">
    <script type="text/javascript">
        ...
        function btnPrint_Click() {
            ...
            fn_OpenPop("../../Common/ReportView.aspx?RPT=CSS1060_RPT&Date=" + txtDate.GetValue(), 500, 500);           
        }        
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="conBody">
   <div id="content">
        <Ctl:Layer ID="layer1" runat="server" Title="B/L별 재고 조회" DefaultHide="False" LangCode="layer1" Description="B/L별 재고 조회">
            <div class="btn_bx">        
            ...
            <Ctl:WebSheet ID="gridIndex" runat="server" Paging="true" HFixation="true" Fixation="true" Height="650" CheckBox="false" Width="100%" TypeName="CSS.CSSBiz" MethodName="UP_CSS1060_LIST" UseColumnSort="true" HeaderHeight="20" CellHeight="30" >
                <Ctl:SheetField DataField="GKDESC1"    TextField="GKDESC1"    Description="곡종"         Width="135"  HAlign="left"  Align="left"  runat="server"  />
                <Ctl:SheetField DataField="IHIPHANG"   TextField="IHIPHANG"   Description="입항일자"     Width="105"   HAlign="left"  Align="left"  runat="server"  />
                <Ctl:SheetField DataField="HANGCHA"    TextField="HANGCHA"    Description="항차"         Width="80"   HAlign="left"  Align="left"  runat="server"  />
                ...
                <Ctl:SheetField DataField="BLMSN"      TextField="BLMSN"      Description="MSN"          Width="45"   HAlign="left"  Align="left"  runat="server"  />
                <Ctl:SheetField DataField="BLHSN"      TextField="BLHSN"      Description="HSN"          Width="45"   HAlign="left"  Align="left"  runat="server"  />
                ...
                <Ctl:SheetField DataField="HAPCHUL"    TextField="HAPCHUL"    Description="출고량"       Width="120"  HAlign="right" Align="right" runat="server" DataType="number" />
