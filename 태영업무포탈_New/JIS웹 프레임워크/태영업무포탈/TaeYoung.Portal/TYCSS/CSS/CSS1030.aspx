<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CSS1030.aspx.cs" Inherits="TaeYoung.Portal.TYCSS.CSS.CSS1030" %>
...
<asp:content id="HeaderContent" runat="server" contentplaceholderid="conHead">
    <script type="text/javascript">
        ...
        function btnPrint_Click() {
            ...
            fn_OpenPop("../../Common/ReportView.aspx?RPT=CSS1030_RPT&Date_Fr=" + txtFRDate.GetValue() + "&Date_To=" + txtTODate.GetValue(), 500, 500);
        }     
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="conBody">
   <div id="content">
        <Ctl:Layer ID="layer1" runat="server" Title="감량확정 모선조회" DefaultHide="False" LangCode="layer1" Description="감량확정 모선조회">
            ...
            <Ctl:WebSheet ID="gridIndex" runat="server" Paging="true" HFixation="true" Fixation="true" CheckBox="false" height="650" TypeName="CSS.CSSBiz" MethodName="UP_CSS1030_LIST" UseColumnSort="true" HeaderHeight="20" CellHeight="30" >
                <Ctl:SheetField DataField="IHHANGCHA"  TextField="IHHANGCHA"  Description="모선"       Width="100"  HAlign="left"  Align="left"   runat="server" AutoMerge="true" />
                <Ctl:SheetField DataField="VSDESC1"    TextField="VSDESC1"    Description="모선명"     Width="230"  HAlign="left"  Align="left"   runat="server" AutoMerge="true" />
                <Ctl:SheetField DataField="IPGOKJONG"  TextField="IPGOKJONG"  Description="곡종"       Width="90"   HAlign="left"  Align="left"   runat="server" AutoMerge="true" />
                <Ctl:SheetField DataField="GKDESC1"    TextField="GKDESC1"    Description="곡종명"     Width="230"  HAlign="left"  Align="left"   runat="server" AutoMerge="true" />
                <Ctl:SheetField DataField="IHIPHANG"   TextField="IHIPHANG"   Description="입항일자"   Width="120"  HAlign="left"  Align="left"   runat="server" AutoMerge="true" />
                <Ctl:SheetField DataField="IHJAKENDAT" TextField="IHJAKENDAT" Description="작업종료일" Width="120"  HAlign="left"  Align="left"   runat="server" AutoMerge="true" />
