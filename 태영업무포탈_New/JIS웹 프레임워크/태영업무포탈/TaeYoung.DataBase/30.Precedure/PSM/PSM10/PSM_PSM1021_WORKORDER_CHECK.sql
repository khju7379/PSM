...
DROP PROCEDURE PSSCMLIB.PSM_PSM1021_WORKORDER_CHECK ; 
  
CREATE PROCEDURE PSSCMLIB.PSM_PSM1021_WORKORDER_CHECK ( 
	...
	LANGUAGE SQL 
	SPECIFIC PSSCMLIB.PSM_PSM1021_WORKORDER_CHECK 
	NOT DETERMINISTIC 
	MODIFIES SQL DATA 
		...
		DECLARE REFCURSOR CURSOR WITH RETURN FOR 
			...
			FROM PSSCMLIB.PSM_WorkOrder
			 LEFT OUTER JOIN (SELECT CAST(P_L3SAUP||P_L3BCODE||P_L3MCODE||P_L3SCODE AS VARCHAR(9))  AS AREACODE    FROM SYSIBM.SYSDUMMY1) AS PAR
				 ON 1 = 1
			WHERE (WOAREACODE1 = PAR.AREACODE OR WOAREACODE2 = PAR.AREACODE OR WOAREACODE3 = PAR.AREACODE OR WOAREACODE4 = PAR.AREACODE OR WOAREACODE5 = PAR.AREACODE) ; 
