...
DROP PROCEDURE TYJINFWLIB.PSM_CODEINDEX_LIST;
  
CREATE PROCEDURE TYJINFWLIB.PSM_CODEINDEX_LIST ( 
	IN P_CURRENTPAGEINDEX INTEGER , 
	IN P_PAGESIZE INTEGER , 
	IN P_SEARCHCONDITION VARCHAR(4000) ) 
	DYNAMIC RESULT SETS 2 
	LANGUAGE SQL 
	SPECIFIC TYJINFWLIB.PSM_CODEINDEX_LIST 
	NOT DETERMINISTIC 
	MODIFIES SQL DATA 
