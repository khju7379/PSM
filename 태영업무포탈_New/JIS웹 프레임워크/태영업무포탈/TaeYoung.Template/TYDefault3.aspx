<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TYDefault3.aspx.cs" Inherits="TaeYoung.Template.TYDefault3" %>
<asp:content id="HeaderContent" runat="server" contentplaceholderid="conHead">
    <script type="text/javascript">
        ...
        function Grid1RowClick(r, c) {
            ...
            gridCodeList.CallBack = function () {
                ...
                for (var i = 0; i < ObjectCount(dt.Rows); i++) {
                    gridCodeList.EditModeDisable(i, 0); // CODE 번호(1)
                    gridCodeList.EditModeDisable(i, 1); // 내용 번호(2)
                }
            }
        }
        ...
        function btnSave_Click() {
            ...
            PageMethods.InvokeServiceTableArray(ht, hts, "QM.QMBiz", "HR_INCODEMF_ADD", function (e) {
                alert("저장이 완료되었습니다.");
            }, function (e) {
                // Biz 연결오류
                alert("Error");
        ...
        function btnDel_Click() {
            ...
            PageMethods.InvokeServiceTableArray(ht, hts, "QM.QMBiz", "HR_INCODEMF_DEL", function (e) {                
                alert("삭제가 완료되었습니다.");
            }, function (e) {
                // Biz 연결오류
                alert("Error");
                ...
                <tr>
                    ...
                    <td valign="top">
                         ...
                         <Ctl:WebSheet ID="gridCodeList" runat="server" Paging="true" CheckBox="true" Width="100%" TypeName="QM.QMBiz" MethodName="UP_HRCODE" UseColumnSort="true">
                            <Ctl:SheetField DataField="CDINDEX" TextField="CDCODE" Description="CODE" Width="60"  HAlign="center" Align="left" Edit="true" runat="server" OnClick="" />
