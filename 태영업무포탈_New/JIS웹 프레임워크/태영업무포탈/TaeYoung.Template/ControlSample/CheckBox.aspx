<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckBox.aspx.cs" Inherits="Temp.WebTemplate.ControlSample.CheckBox" %>
<asp:content id="HeaderContent" runat="server" contentplaceholderid="conHead">
    <script type="text/javascript">
        ...
        function OnLoad() {
            ...
            // chkBox16 체크박스 BindList
            setChkBox16();

            //chkBox17 CallBack함수
            chkBox17.CallBack = function () {
                alert();
            };
        }

        /********************************************************************************************
        * 함수명      : btnChkBox10_Click()
        * 작성목적    : GetValue()
        * Parameter   :
        * Return      :
        * 작성자      : 이정홍
        ...
        * 수정내역    :
        ********************************************************************************************/
        function btnChkBox10_Click() {
            alert(chkBox10.GetValue());
            return false;
        }

        /********************************************************************************************
        * 함수명      : btnChkBox11_Click()
        * 작성목적    : GetValue()
        * Parameter   :
        * Return      :
        * 작성자      : 이정홍
        ...
        * 수정내역    :
        ********************************************************************************************/
        function btnChkBox11_Click() {
            alert(chkBox11.GetText());
            return false;
        }
        ...
        * 수정내역    :
        ********************************************************************************************/
        function setChkBox16() {
            var ht = new Object();
            ht["PageSize"] = 3;

            chkBox16.TypeName = "Template.TemplateBiz";
            chkBox16.MethodName = "ListTemplate";
            chkBox16.DataTextField = "TITLE";
            chkBox16.DataValueField = "IDX";
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="conBody">
    <!--타이틀시작-->
    <div id="title">
        <h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/ ControlSample / CheckBox
        <Ctl:Text ID="tSubject" runat="server" LangCode="tSubject" Description="CheckBox Control Sample" Literal="true"></Ctl:Text></h4>
        <div class="btn_bx">
            <!-- 상단의 버튼을 정의 -->
        </div>
        <div class="clear"></div>
    ...
    <div id="content">
        ...
        <!--기본샘플-->
        <Ctl:Layer ID="layer1" runat="server" Title="CheckBox Control 기본샘플" DefaultHide="False">
                ...
                <tr>
                    ...
                    <td>
                        <Ctl:Text ID="TXT53" runat="server" LangCode="TXT53" Description="
                            &#60Ctl:CheckBox ID=&#34;chkIDX1&#34; runat=&#34;server&#34; DataMember=&#34;IDX&#34; ReadMode=&#34;false&#34; &#62<br />
                            &nbsp;&nbsp;&nbsp;&nbsp;&#60asp:ListItem Text=&#34;첫번째&#34; Value=&#34;1&#34; Selected=&#34;true&#34; &#62&#60/asp:ListItem&#62<br />
                ...
                <tr>
                    ...
                    <td>
                        <Ctl:Text ID="TXT04" runat="server" LangCode="TXT04" Description="
                            &#60Ctl:CheckBox ID=&#34;chkIDX2&#34; runat=&#34;server&#34; DataMember=&#34;IDX&#34;<br />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TypeName=&#34;Template.TemplateBiz&#34; MethodName=&#34;ListTemplate&#34; Params=&#34;{'PageSize':3}&#34;<br />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DataTextField=&#34;TITLE&#34; DataValueField=&#34;IDX&#34; ReadMode=&#34;false&#34; &#62<br />
                            &#60/Ctl:CheckBox&#62
                        "></Ctl:Text>
                    </td>
                    <td>
                        <Ctl:CheckBox ID="chkIDX2" runat="server" DataMember="IDX" TypeName="Template.TemplateBiz" MethodName="ListTemplate" Params="{'PageSize':3}" DataTextField="TITLE"  DataValueField="IDX" ReadMode="false">
                        </Ctl:CheckBox>
                    </td>
                </tr>
            </table>
        ...
        <!--샘플 DataSet-->
        <Ctl:Layer ID="layer2" runat="server" Title="CheckBox Control 샘플 DataSet" DefaultHide="False">
            <table class="table_01" style="width: 100%;">
                <colgroup>
                    <col width="17%" />
                    <col width="13%" />
        ...
        <!--Properties List-->
        <Ctl:Layer ID="layer3" runat="server" Title="CheckBox Control Properties" DefaultHide="False">
            <table class="table_01" style="width: 100%;">
                <colgroup>
                    <col width="20%" />
                    <col width="80%" />
                ...
                <tr>
                    ...
                    <td>
                        <Ctl:Text ID="TXT62" runat="server" LangCode="TXT62" Description="- 해당 컨트롤의 체크박스를 직접 추가한다."></Ctl:Text>
                    </td>
                </tr>
                <tr>
                    <td style="text-align:center;">
        ...
        <!--Events List-->
        <Ctl:Layer ID="layer4" runat="server" Title="CheckBox Control Events" DefaultHide="False">
            <table class="table_01" style="width: 100%;">
                <colgroup>
                    <col width="20%" />
                    <col width="80%" />
        ...
        <!--Functions List-->
        <Ctl:Layer ID="layer5" runat="server" Title="CheckBox Control Functions" DefaultHide="False">
            <table class="table_01" style="width: 100%;">
                <colgroup>
                    <col width="20%" />
                    <col width="80%" />
        ...
        <!--Properties Examples-->
        <Ctl:Layer ID="layer6" runat="server" Title="CheckBox Control Properties Examples" DefaultHide="False">
            <table class="table_01" style="width: 100%;">
                <colgroup>
                    <col width="20%" />
                    <col width="50%" />
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <Ctl:Text ID="TXT101" runat="server" LangCode="TXT101" Description="- 해당 컨트롤의 체크박스를 직접 추가한다."></Ctl:Text>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&#183; Text:체크박스의 Text, Value:체크박스의 Value, Selected:체크박스의 Default 선택
                        "></Ctl:Text>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <Ctl:CheckBox ID="chkBox2" runat="server">
                            <asp:ListItem Text="첫번째" Value="1" Selected="true"></asp:ListItem>
                            <asp:ListItem Text="두번째" Value="2" ></asp:ListItem>
                            <asp:ListItem Text="세번째" Value="3" ></asp:ListItem>
                        </Ctl:CheckBox>
                ...
                <tr>
                    ...
                    <td>
                        <Ctl:CheckBox ID="chkBox9" runat="server" DataMember="TITLE">
                ...
                <tr>
                    ...
                    <td>
                        <Ctl:CheckBox ID="chkBox6" runat="server" TypeName="Template.TemplateBiz" MethodName="ListTemplate" Params="{'PageSize':5}" DataTextField="TITLE"  DataValueField="IDX"></Ctl:CheckBox>
                    </td>
                </tr>
                <tr>
                    <td rowspan="3" style="text-align:center;">
                ...
                <tr>
                    ...
                    <td>
                        <Ctl:CheckBox ID="chkBox7" runat="server" TypeName="Template.TemplateBiz" MethodName="ListTemplate" Params="{'PageSize':5}" DataTextField="TITLE"  DataValueField="IDX"></Ctl:CheckBox>
                    </td>
                </tr>
                <tr>
                    <td rowspan="3" style="text-align:center;">
                ...
                <tr>
                    ...
                    <td>
                        <Ctl:CheckBox ID="chkBox4" runat="server" TypeName="Template.TemplateBiz" MethodName="ListTemplate" Params="{'PageSize':5}" DataTextField="TITLE"  DataValueField="IDX"></Ctl:CheckBox>
                    </td>
                </tr>
                <tr>
                    <td rowspan="3" style="text-align:center;">
                ...
                <tr>
                    ...
                    <td>
                        <Ctl:CheckBox ID="chkBox5" runat="server" TypeName="Template.TemplateBiz" MethodName="ListTemplate" Params="{'PageSize':8}" DataTextField="TITLE"  DataValueField="IDX"></Ctl:CheckBox>
                    </td>
                </tr>
                <tr>
                    <td rowspan="3" style="text-align:center;">
                ...
                <tr>
                    ...
                    <td>
                        <Ctl:CheckBox ID="chkBox8" runat="server" ReadMode="true">
                ...
                <tr>
                    ...
                    <td>
                        <Ctl:CheckBox ID="chkBox3" runat="server" TypeName="Template.TemplateBiz" MethodName="ListTemplate" Params="{'PageSize':5}" DataTextField="TITLE"  DataValueField="IDX"></Ctl:CheckBox>
                    </td>
                </tr>
            </table>
        </Ctl:Layer>
        ...
        <!--Events Examples-->
        <Ctl:Layer ID="layer7" runat="server" Title="CheckBox Control Events Examples" DefaultHide="False">
            <table class="table_01" style="width: 100%;">
                <colgroup>
                    <col width="20%" />
                    <col width="50%" />
        ...
        <!--Functions Examples-->
        <Ctl:Layer ID="layer8" runat="server" Title="CheckBox Control Functions Examples" DefaultHide="False">
            <table class="table_01" style="width: 100%;">
                <colgroup>
                    <col width="20%" />
                    <col width="50%" />
                ...
                <tr>
                    <td>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;chkBox16.TypeName = &#34;Template.TemplateBiz&#34;;<br />
                        &nbsp;&nbsp;&nbsp;&nbsp;chkBox16.MethodName = &#34;ListTemplate&#34;;<br />
                        &nbsp;&nbsp;&nbsp;&nbsp;chkBox16.DataTextField = &#34;TITLE&#34;;<br />
                        &nbsp;&nbsp;&nbsp;&nbsp;chkBox16.DataValueField = &#34;IDX&#34;;<br />
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;<p style='display:inline;color:Green;'>/* 데이터 바인딩 시 넘길 파라미터 */</p><br />
                        &nbsp;&nbsp;&nbsp;&nbsp;var ht = new Object();<br />
                        &nbsp;&nbsp;&nbsp;&nbsp;ht[&#34;PageSize&#34;] = 3;<br />
                        &nbsp;&nbsp;&nbsp;&nbsp;chkBox16.Params(ht);<br />
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;<p style='display:inline;color:Green;'>/* 데이터 바인딩 */</p><br />
                        &nbsp;&nbsp;&nbsp;&nbsp;<p style='display:inline;color:Blue;'>chkBox16.BindList();</p>
                        "></Ctl:Text>
                    </td>
                    <td>
                        <Ctl:CheckBox ID="chkBox16" runat="server"></Ctl:CheckBox>
                    </td>
                </tr>
                <tr>
                    <td rowspan="3" style="text-align:center;">
                ...
                <tr>
                    <td>
                        ...
                        <p style='display:inline;color:Green;'>/* OnLoad 에서 chkBox17 CallBack함수 */</p><br />
                        <p style='display:inline;color:Blue;'>chkBox17.CallBack = function () {</p><br />
                        &nbsp;&nbsp;&nbsp;&nbsp;alert();<br />
                        <p style='display:inline;color:Blue;'>};</p>
                        "></Ctl:Text>
                    </td>
                    <td>
                        <Ctl:CheckBox ID="chkBox17" runat="server" TypeName="Template.TemplateBiz" MethodName="ListTemplate" Params="{'PageSize':5}" DataTextField="TITLE"  DataValueField="IDX"></Ctl:CheckBox>
                        <div style="margin-top:10px;">
                            <Ctl:Button ID="btnChkBox17" runat="server" LangCode="btnChkBox17" Description="BindList()" OnClientClick="chkBox17.BindList();"></Ctl:Button>
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        ...
                        <p style='display:inline;color:Blue;'>chkBox11.GetText();</p>
                        "></Ctl:Text>
                    </td>
                    <td>
                        &nbsp;
                ...
                <tr>
                    <td>
                        ...
                        <p style='display:inline;color:Blue;'>chkBox10.GetValue();</p>
                        "></Ctl:Text>
                    </td>
                    <td>
                        &nbsp;
                ...
                <tr>
                    <td>
                        ...
                        <p style='display:inline;color:Blue;'>chkBox13.Hide();</p>
                        "></Ctl:Text>
                    </td>
                    <td>
                        <Ctl:CheckBox ID="chkBox13" runat="server">
                            <asp:ListItem Value="1" Text="첫번째"></asp:ListItem>
                            <asp:ListItem Value="2" Text="두번째"></asp:ListItem>
                            <asp:ListItem Value="3" Text="세번째"></asp:ListItem>
                        </Ctl:CheckBox>
                        <div style="margin-top:10px;">
                            <Ctl:Button ID="btnChkBox13" runat="server" LangCode="btnChkBox13" Description="Hide()" OnClientClick="chkBox13.Hide();"></Ctl:Button>
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        ...
                        <p style='display:inline;color:Blue;'>chkBox15.SetDisabled(true);</p> <p style='display:inline;color:Green;'> /* 비활성화 */ </p><br />
                        <p style='display:inline;color:Blue;'>chkBox15.SetDisabled(false);</p> <p style='display:inline;color:Green;'> /* 활성화 */ </p>
                        "></Ctl:Text>
                    </td>
                    <td>
                        <Ctl:CheckBox ID="chkBox15" runat="server">
                            <asp:ListItem Value="1" Text="첫번째"></asp:ListItem>
                            <asp:ListItem Value="2" Text="두번째"></asp:ListItem>
                            <asp:ListItem Value="3" Text="세번째"></asp:ListItem>
                        </Ctl:CheckBox>
                        <div style="margin-top:10px;">
                            <Ctl:Button ID="btnChkBox15_1" runat="server" LangCode="btnChkBox15_1" Description="비활성화" OnClientClick="chkBox15.SetDisabled(true);"></Ctl:Button>
                            <Ctl:Button ID="btnChkBox15_2" runat="server" LangCode="btnChkBox15_2" Description="활성화" OnClientClick="chkBox15.SetDisabled(false);"></Ctl:Button>
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&#183; (컨트롤ID).SetValue(str); <p style='display:inline;color:Green;'>/* str 변수에는 변경할 Value를 준다. */</p> <br/>
                         &nbsp;&nbsp;&nbsp;&nbsp;&#183; str = Value , 전체 체크해제 시 : str = &#34;&#34;
                        "></Ctl:Text>
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        <p style='display:inline;color:Blue;'>chkBox12.SetValue(1);</p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<p style='display:inline;color:Green;'>/* Value=1 인 &#34;첫번째&#34; 체크박스 체크 */</p><br />
                        <p style='display:inline;color:Blue;'>chkBox12.SetValue(&#34;&#34;);</p>&nbsp;&nbsp;&nbsp;&nbsp;<p style='display:inline;color:Green;'>/* 체크해제 */</p>
                        "></Ctl:Text>
                    </td>
                    <td>
                        <Ctl:CheckBox ID="chkBox12" runat="server">
                            <asp:ListItem Value="1" Text="첫번째"></asp:ListItem>
                            <asp:ListItem Value="2" Text="두번째"></asp:ListItem>
                            <asp:ListItem Value="3" Text="세번째"></asp:ListItem>
                        </Ctl:CheckBox>
                        <div style="margin-top:10px;">
                            <Ctl:Button ID="btnChkBox12_2" runat="server" LangCode="btnChkBox12_2" Description="첫번째 체크" OnClientClick="chkBox12.SetValue(1);"></Ctl:Button>
                            <Ctl:Button ID="btnChkBox12_1" runat="server" LangCode="btnChkBox12_1" Description="체크해제" OnClientClick="chkBox12.SetValue('');"></Ctl:Button>
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        ...
                        <p style='display:inline;color:Blue;'>chkBox14.Show();</p>
                        "></Ctl:Text>
                    </td>
                    <td>
                        <Ctl:CheckBox ID="chkBox14" runat="server">
                            <asp:ListItem Value="1" Text="첫번째"></asp:ListItem>
                            <asp:ListItem Value="2" Text="두번째"></asp:ListItem>
                            <asp:ListItem Value="3" Text="세번째"></asp:ListItem>
                        </Ctl:CheckBox>
                        <div style="margin-top:10px;">
                            <Ctl:Button ID="btnChkBox14" runat="server" LangCode="btnChkBox14" Description="Show()" OnClientClick="chkBox14.Show();"></Ctl:Button>
                        </div>
                    </td>
                </tr>
            </table>
