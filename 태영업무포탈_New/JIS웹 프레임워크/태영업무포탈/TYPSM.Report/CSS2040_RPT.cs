...
namespace TYPSM.Report
{
    ...
    /// </summary>
    public partial class CSS2040_RPT : GrapeCity.ActiveReports.SectionReport
    {
        ...
        public CSS2040_RPT(System.Collections.Specialized.NameValueCollection QueryString)
        {
            InitializeComponent();
        ...
        private void UP_DataBing()
        {
            ...
            using (TaeYoung.Biz.CSS.CSSBiz biz = new TaeYoung.Biz.CSS.CSSBiz())
            {
                ...
                DataSet ds = biz.UP_CSS2040_LIST(ht);
