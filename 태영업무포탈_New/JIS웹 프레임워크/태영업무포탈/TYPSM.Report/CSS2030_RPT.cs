...
namespace TYPSM.Report
{
    ...
    /// </summary>
    public partial class CSS2030_RPT : GrapeCity.ActiveReports.SectionReport
    {
        ...
        public CSS2030_RPT(System.Collections.Specialized.NameValueCollection QueryString)
        {
            InitializeComponent();
        ...
        private void UP_DataBing()
        {
            ...
            using (TaeYoung.Biz.CSS.CSSBiz biz = new TaeYoung.Biz.CSS.CSSBiz())
            {
                ...
                DataSet ds = biz.UP_CSS2030_LIST(ht);
        ...
        private void detail_Format(object sender, EventArgs e)
        {
            //if (fiCount > 0)
            //{
            //    if (_dt.Rows[fiCount - 1]["USHWAJU"].ToString() != _dt.Rows[fiCount]["USHWAJU"].ToString())
            //    {
