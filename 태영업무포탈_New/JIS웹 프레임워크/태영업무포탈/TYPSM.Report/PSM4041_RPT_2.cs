...
namespace TYPSM.Report
{
    ...
    /// </summary>
    public partial class PSM4041_RPT_2 : GrapeCity.ActiveReports.SectionReport
    {
        ...
        public PSM4041_RPT_2(System.Collections.Specialized.NameValueCollection QueryString)
        {   
            //
        ...
        public PSM4041_RPT_2(string QueryString) // 웹 서비스 호출 용
        {
            //
            // Required for Windows Form Designer support
            //
        ...
        private void pageHeader_Format(object sender, EventArgs e)
        {
            ...
            this.SSCODENAME3_1.Text = _dt5[iPageNum].Rows[33]["NAME"].ToString();
            this.SSCODENAME3_2.Text = _dt5[iPageNum].Rows[34]["NAME"].ToString();
            this.SSCODENAME3_3.Text = _dt5[iPageNum].Rows[35]["NAME"].ToString();
            this.SSCODENAME3_4.Text = _dt5[iPageNum].Rows[36]["NAME"].ToString();
            this.SSCODENAME3_5.Text = _dt5[iPageNum].Rows[37]["NAME"].ToString();
            this.SSCODENAME3_6.Text = _dt5[iPageNum].Rows[38]["NAME"].ToString();
            this.SSCODENAME3_7.Text = _dt5[iPageNum].Rows[39]["NAME"].ToString();
            this.SSCODENAME3_8.Text = _dt5[iPageNum].Rows[40]["NAME"].ToString();
            this.SSCODENAME3_9.Text = _dt5[iPageNum].Rows[41]["NAME"].ToString();
            this.SSCODENAME3_10.Text = _dt5[iPageNum].Rows[42]["NAME"].ToString();
            this.SSCODENAME3_11.Text = _dt5[iPageNum].Rows[43]["NAME"].ToString();
            this.SSCODENAME3_12.Text = _dt5[iPageNum].Rows[44]["NAME"].ToString();
            this.SSCODENAME3_13.Text = _dt5[iPageNum].Rows[45]["NAME"].ToString();
            this.SSCODENAME3_14.Text = _dt5[iPageNum].Rows[46]["NAME"].ToString();
            ...
            this.SSCODENAME4_1.Text = _dt5[iPageNum].Rows[47]["NAME"].ToString();
            this.SSCODENAME4_2.Text = _dt5[iPageNum].Rows[48]["NAME"].ToString();
            this.SSCODENAME4_3.Text = _dt5[iPageNum].Rows[49]["NAME"].ToString();
            this.SSCODENAME4_4.Text = _dt5[iPageNum].Rows[50]["NAME"].ToString();
            this.SSCODENAME4_5.Text = _dt5[iPageNum].Rows[51]["NAME"].ToString();
            this.SSCODENAME4_6.Text = _dt5[iPageNum].Rows[52]["NAME"].ToString();
            this.SSCODENAME4_7.Text = _dt5[iPageNum].Rows[53]["NAME"].ToString();
            this.SSCODENAME4_8.Text = _dt5[iPageNum].Rows[54]["NAME"].ToString();
            this.SSCODENAME4_9.Text = _dt5[iPageNum].Rows[55]["NAME"].ToString();
            ...
            this.SSCODENAME5_1.Text = _dt5[iPageNum].Rows[56]["NAME"].ToString();
            this.SSCODENAME5_2.Text = _dt5[iPageNum].Rows[57]["NAME"].ToString();
            this.SSCODENAME5_3.Text = _dt5[iPageNum].Rows[58]["NAME"].ToString();
            this.SSCODENAME5_4.Text = _dt5[iPageNum].Rows[59]["NAME"].ToString();
            ...
            this.SSCODENAME6_1.Text = _dt5[iPageNum].Rows[60]["NAME"].ToString();
            this.SSCODENAME6_2.Text = _dt5[iPageNum].Rows[61]["NAME"].ToString();
            this.SSCODENAME6_3.Text = _dt5[iPageNum].Rows[62]["NAME"].ToString();
            ...
            this.SSCODENAME7_1.Text = _dt5[iPageNum].Rows[63]["NAME"].ToString();
            this.SSCODENAME7_2.Text = _dt5[iPageNum].Rows[64]["NAME"].ToString();
            this.SSCODENAME7_3.Text = _dt5[iPageNum].Rows[65]["NAME"].ToString();
            this.SSCODENAME7_4.Text = _dt5[iPageNum].Rows[66]["NAME"].ToString();
            this.SSCODENAME7_5.Text = _dt5[iPageNum].Rows[67]["NAME"].ToString();
            this.SSCODENAME7_6.Text = _dt5[iPageNum].Rows[68]["NAME"].ToString();
            this.SSCODENAME7_7.Text = _dt5[iPageNum].Rows[69]["NAME"].ToString();
            ...
            this.SSCODENAME9_1.Text = _dt5[iPageNum].Rows[70]["NAME"].ToString();
            this.SSCODENAME9_2.Text = _dt5[iPageNum].Rows[71]["NAME"].ToString();
            this.SSCODENAME9_3.Text = _dt5[iPageNum].Rows[72]["NAME"].ToString();
            this.SSCODENAME9_4.Text = _dt5[iPageNum].Rows[73]["NAME"].ToString();
            this.SSCODENAME9_5.Text = _dt5[iPageNum].Rows[74]["NAME"].ToString();
            this.SSCODENAME9_6.Text = _dt5[iPageNum].Rows[75]["NAME"].ToString();
            this.SSCODENAME9_7.Text = _dt5[iPageNum].Rows[76]["NAME"].ToString();
            this.SSCODENAME9_8.Text = _dt5[iPageNum].Rows[77]["NAME"].ToString();
            this.SSCODENAME9_9.Text = _dt5[iPageNum].Rows[78]["NAME"].ToString();
            this.SSCODENAME9_10.Text = _dt5[iPageNum].Rows[79]["NAME"].ToString();
            this.SSCODENAME9_11.Text = _dt5[iPageNum].Rows[80]["NAME"].ToString();
            this.SSCODENAME9_12.Text = _dt5[iPageNum].Rows[81]["NAME"].ToString();
            this.SSCODENAME9_13.Text = _dt5[iPageNum].Rows[82]["NAME"].ToString();
            this.SSCODENAME9_14.Text = _dt5[iPageNum].Rows[83]["NAME"].ToString();
            this.SSCODENAME9_15.Text = _dt5[iPageNum].Rows[84]["NAME"].ToString();
            this.SSCODENAME9_16.Text = _dt5[iPageNum].Rows[85]["NAME"].ToString();
        ...
        private void PSM4041_RPT_2_ReportEnd(object sender, EventArgs e)
        {
            if (_PRINTNAME != "")
            {
                // 순서 바뀌면 안됨
