...
namespace TYPSM.Report
{
    ...
    /// </summary>
    public partial class PSM4041_RPT_4 : GrapeCity.ActiveReports.SectionReport
    {
        ...
        public PSM4041_RPT_4(System.Collections.Specialized.NameValueCollection QueryString)
        {
            //
        ...
        public PSM4041_RPT_4(string QueryString) // 웹 서비스 호출 용
        {
            //
            // Required for Windows Form Designer support
            //
        ...
        private void PSM4041_RPT_4_ReportEnd(object sender, EventArgs e)
        {
            if (_PRINTNAME != "")
            {
                // 순서 바뀌면 안됨
