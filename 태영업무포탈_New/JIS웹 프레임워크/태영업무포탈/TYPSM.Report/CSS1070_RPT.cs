...
namespace TYPSM.Report
{
    ...
    /// </summary>
    public partial class CSS1070_RPT : GrapeCity.ActiveReports.SectionReport
    {
        ...
        public CSS1070_RPT(System.Collections.Specialized.NameValueCollection QueryString)
        {
            //
            // Required for Windows Form Designer support
            //
        ...
        private void UP_DataBing()
        {
            ...
            using (TaeYoung.Biz.CSS.CSSBiz biz = new TaeYoung.Biz.CSS.CSSBiz())
            {
                ...
                DataSet ds = biz.UP_CSS1070_LIST(ht);
