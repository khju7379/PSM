...
namespace TYPSM.Report
{
    ...
    /// </summary>
    public partial class CSI1040_RPT : GrapeCity.ActiveReports.SectionReport
    {
        ...
        public CSI1040_RPT(System.Collections.Specialized.NameValueCollection QueryString)
        {
            //
            // Required for Windows Form Designer support
            //
        ...
        private void UP_DataBing()
        {
            ...
            using (TaeYoung.Biz.CSI.CSIBiz biz = new TaeYoung.Biz.CSI.CSIBiz())
            {
                ...
                DataSet ds = biz.UP_CSI1040_LIST(ht);
