...
namespace TYPSM.Report
{
    ...
    /// </summary>
    public partial class PSM4041_RPT_3 : GrapeCity.ActiveReports.SectionReport
    {
        ...
        public PSM4041_RPT_3(System.Collections.Specialized.NameValueCollection QueryString)
        {
            //
        ...
        public PSM4041_RPT_3(string QueryString) // 웹 서비스 호출 용
        {
            //
            // Required for Windows Form Designer support
            //
        ...
        private void PSM4041_RPT_3_ReportEnd(object sender, EventArgs e)
        {
            if (_PRINTNAME != "")
            {
                // 순서 바뀌면 안됨
