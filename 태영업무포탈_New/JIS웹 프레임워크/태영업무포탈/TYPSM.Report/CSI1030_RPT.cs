...
{
    /// <summary>
    /// Summary description for CSI1030_RPT.
    /// </summary>
    public partial class CSI1030_RPT : GrapeCity.ActiveReports.SectionReport
    {
        ...
        public CSI1030_RPT(System.Collections.Specialized.NameValueCollection QueryString)
        {
            //
            // Required for Windows Form Designer support
            //
        ...
        private void UP_DataBing()
        {
            ...
            using (TaeYoung.Biz.CSI.CSIBiz biz = new TaeYoung.Biz.CSI.CSIBiz())
            {
                ...
                DataSet ds = biz.UP_CSI1030_LIST(ht);
