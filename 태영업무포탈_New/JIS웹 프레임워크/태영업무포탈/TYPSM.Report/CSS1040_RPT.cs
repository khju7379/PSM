...
{
    /// <summary>
    /// Summary description for CSS1040_RPT.
    /// </summary>
    public partial class CSS1040_RPT : GrapeCity.ActiveReports.SectionReport
    {
        ...
        public CSS1040_RPT(System.Collections.Specialized.NameValueCollection QueryString)
        {
            //
            // Required for Windows Form Designer support
            //
        ...
        private void UP_DataBing()
        {
            ...
            using (TaeYoung.Biz.CSS.CSSBiz biz = new TaeYoung.Biz.CSS.CSSBiz())
            {
                ...
                DataSet ds = biz.UP_CSS1040_LIST(ht);
        ...
        private void pageHeader_Format(object sender, EventArgs e)
        {
            ...
            DATE.Text  = fsDate_Fr.Substring(0, 4) + "/" + fsDate_Fr.Substring(4, 2) + " ~ " +
                         fsDate_To.Substring(0, 4) + "/" + fsDate_To.Substring(4, 2);
        }
    }
}
