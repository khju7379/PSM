    ...
    public class PSM4040 : BizBase
    {
        ...
        public DataSet UP_GET_WORKORDER_LIST(Hashtable ht)
        {
            using (DB2Connecter dbCon = new DB2Connecter("DB2"))
            {
                ...
                return dbCon.ExcuteDataSet("PSSCMLIB.PSM_PSM4040_WORKORDER_LIST");
            }
        }
        #endregion
        ...
        public DataSet UP_SAFEORDER_MASTER_SAVE(Hashtable ht)
        {
            ...
            using (DB2Connecter dbCon = new DB2Connecter("DB2"))
            {
                ...
                dbCon.AddParameters("P_SMMATERTEXT2", DbType.String, Convert.ToString(ht["P_SMMATERTEXT2"]).Replace("\r\n", "<br />").Replace("\n", "<br />"));
                ...
                dbCon.AddParameters("P_SMORDERTEXT1", DbType.String, Convert.ToString(ht["P_SMORDERTEXT1"]).Replace("\r\n", "<br />").Replace("\n", "<br />"));
                ...
                dbCon.AddParameters("P_SMFIREINS", DbType.String, ht["P_SMFIREINS"]);
        ...
        public DataSet UP_SAFEORDER_FINISH_UPT(Hashtable ht)
        {
            ...
            // 로직추가
            // 단순교체이면 작업완료 가능
            // 단순교체이면 WOSTATUS에 '5'로 업데이트 함
            // 변경교체이면 작업완료 불가능 => SELECT 해야 함
            ...
            using (DB2Connecter dbCon = new DB2Connecter("DB2"))
            {
                ...
                {
                    // 1 = 단순교체, 2 = 변경교체
                    sWOCHANGEWKDIV = ds.Tables[0].Rows[0]["WOCHANGEWKDIV"].ToString();
                }
            }

            if (sWOCHANGEWKDIV.ToString() == "2") // 변경교체
            {
                if (ht["P_SMFSWKCLOSE"].ToString() == "Y")
                {
                    ...
                    row = dt.NewRow();
                    row["STATE"] = "ERR";
                    row["MSG"]   = "변경교체는 공사 완료를 안전작업허가서에서 불가합니다. 공사 완료는 가동전 전결 화면에서 수행하세요. ";
                    dt.Rows.Add(row);
                }
            }
            ...
            if (sSTATE == "")
            {
                ...
                if (sSTATE == "")
                {
                    using (DB2Connecter dbCon = new DB2Connecter("DB2"))
                    {
                        ...
                        dbCon.AddParameters("P_SMFSWKTEXT",    DbType.String,     Convert.ToString(ht["P_SMFSWKTEXT"]).Replace("\r\n", "<br />").Replace("\n", "<br />"));
                        dbCon.AddParameters("P_SMWKTEAM",      DbType.String,     ht["P_SMWKTEAM"]);
                        dbCon.AddParameters("P_SMWKDATE",      DbType.String,     Get_Date(ht["P_SMWKDATE"].ToString()));
                        dbCon.AddParameters("P_SMWKSEQ",       DbType.VarNumeric, Set_Fill3(ht["P_SMWKSEQ"].ToString()));
                        dbCon.AddParameters("P_SMWKORAPPDATE", DbType.String,     Get_Date(ht["P_SMWKORAPPDATE"].ToString()));
                ...
                if (sSTATE == "")
                {
                    if (ht["P_SMFSWKCLOSE"].ToString() == "Y")
                    {
                        ...
                        using (DB2Connecter dbCon = new DB2Connecter("DB2"))
                        {
                            dbCon.AddParameters("P_WOSTATUS", DbType.String,     "5");
                            dbCon.AddParameters("P_WOORTEAM", DbType.String,     ht["P_SMWKTEAM"]);
                            dbCon.AddParameters("P_WOORDATE", DbType.String,     Get_Date(ht["P_SMWKDATE"].ToString()));
                            dbCon.AddParameters("P_WOSEQ",    DbType.VarNumeric, Set_Fill3(ht["P_SMWKSEQ"].ToString()));
                        ...
                        UP_Mail_WK_Send(ht["P_SMWKTEAM"].ToString(),                Get_Date(ht["P_SMWKDATE"].ToString()),   Set_Fill3(ht["P_SMWKSEQ"].ToString()),
                                        Get_Date(ht["P_SMWKORAPPDATE"].ToString()), Set_Fill3(ht["P_SMWKORSEQ"].ToString()),
        ...
        public DataSet UP_SAFEORDER_WORK_CANCEL(Hashtable ht)
        {
            ...
            if (sSTATE == "")
            {
                using (DB2Connecter dbCon = new DB2Connecter("DB2"))
                {
                    ...
                    dbCon.AddParameters("P_SMCNREASON",    DbType.String,     Convert.ToString(ht["P_SMCNREASON"]).Replace("\r\n", "<br />").Replace("\n", "<br />"));
                    dbCon.AddParameters("P_SMWKTEAM",      DbType.String,     ht["P_SMWKTEAM"]);
                    dbCon.AddParameters("P_SMWKDATE",      DbType.String,     Get_Date(ht["P_SMWKDATE"].ToString()));
                    dbCon.AddParameters("P_SMWKSEQ",       DbType.VarNumeric, Set_Fill3(ht["P_SMWKSEQ"].ToString()));
                    dbCon.AddParameters("P_SMWKORAPPDATE", DbType.String,     Get_Date(ht["P_SMWKORAPPDATE"].ToString()));
        ...
        #region Description : 안전작업허가서 철회
        public DataSet UP_SAFEORDER_RETRACT(Hashtable ht)
        {
            DataSet ds = new DataSet();
            DataTable dt = new DataTable();
            DataRow row;
            ...
            try
            {
                ...
                using (DB2Connecter dbCon = new DB2Connecter("DB2"))
                {
                    ...
                    // 안전작업허가서 결재 초기화
                    ds = UP_SAFEORDER_Approval_Init(ht);
        ...
        private DataSet UP_RETRACT_Mail_Send(Hashtable ht)
        {
            ...
            string sSMAREATEXT1 = string.Empty;
            string sRETRACTCOMMENT = string.Empty;

            string sSABUN = string.Empty;

            string sParamUrl = string.Empty;
            string sAPNUM = string.Empty;    // 요청번호
            string sRONUM = string.Empty;    // 허가번호
            ...
            sParamUrl = sParamUrl + sAPNUM + "-" + sRONUM;
            ...
            sSMAREATEXT1 = ht["P_SMAREATEXT1"].ToString();
            ...
            using (DB2Connecter dbCon = new DB2Connecter("DB2"))
            {
                ...
                ds = dbCon.ExcuteDataSet("PSSCMLIB.PSM_PSM4041_SAFEORDER_RETRACT");
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    for (i = 0; i < ds.Tables[0].Rows.Count; i++)
                    {
                        ...
                        sSABUN = ds.Tables[0].Rows[i]["SABUN"].ToString();

                        sUrl = "http://psm.taeyoung.co.kr/Portal/SitePostUrl.aspx?url=http://psm.taeyoung.co.kr/Portal/PortalLogin.aspx&ACTION=APPPAGE&SABUN=" + sSABUN + "&ID=" + sSABUN + "&LINKURL=" + sParamUrl;
                        ...
                        mess.Subject = "[결재철회/안전작업허가서 - " + sWOWORKTITLE.ToString() + "]";
                        ...
                        try
                        {
                            ...
                            sLine += "            </tr> ";
                            sLine += "        <tr> ";
                            sLine += "            <th style = 'font-family:맑은 고딕,Verdana,sans-serif;width:120px;padding:10px 10px 10px 30px;;border-bottom:1px solid #EAEAEA;text-align:left; background:#DEDEEF;'> 요청 번호 </th> ";
                            ...
                            sLine += "        <tr> ";
                            sLine += "            <th style = 'font-family:맑은 고딕,Verdana,sans-serif;width:120px;padding:10px 10px 10px 30px;;border-bottom:1px solid #EAEAEA;text-align:left; background:#DEDEEF;'> 허가 번호 </th> ";
                            ...
                            sLine += "        <tr> ";
                            sLine += "            <th style = 'font-family:맑은 고딕,Verdana,sans-serif;width:120px;padding:10px 10px 10px 30px;;border-bottom:1px solid #EAEAEA;text-align:left; background:#DEDEEF;'> 작업 내용 </th> ";
                            ...
                            sLine += "        </tr> ";
                            sLine += "        <tr> ";
                            sLine += "            <th height=300 style = 'font-family:맑은 고딕,Verdana,sans-serif;width:120px;padding:10px 10px 10px 30px;;border-bottom:1px solid #EAEAEA;text-align:left; background:#DEDEEF;'> 철회 의견 </th> ";
        ...
        #region Description : 안전작업허가서 결재 초기화
        public DataSet UP_SAFEORDER_Approval_Init(Hashtable ht)
        {
            DataSet ds = new DataSet();
            DataTable dt = new DataTable();
            DataRow row;
            ...
            using (DB2Connecter dbCon = new DB2Connecter("DB2"))
            {
                ...
                dbCon.ExcuteNonQuery("PSSCMLIB.PSM_PSM4041_SAFEORDER_MASTER_RETRACT_UPT");
        ...
        #region Description : 안전작업허가서 반려
        public DataSet UP_SAFEORDER_CANCEL(Hashtable ht)
        {
            DataSet ds = new DataSet();
            DataTable dt = new DataTable();
            DataRow row;
        ...
        #region Description : 반려 메일 발송
        private DataSet UP_CANCEL_Mail_Send(Hashtable ht)
        {
            string sMailFrom = string.Empty;
            string sMailTo = string.Empty;
            ...
            string sWOWORKTITLE = string.Empty;
            string sSMAREATEXT1 = string.Empty;
            string sCANCELCOMMENT = string.Empty;
            ...
            sSENDER         = ht["P_SENDER"].ToString();
            sCANCELCOMMENT = ht["P_CANCELCOMMENT"].ToString();
            ...
            using (DB2Connecter dbCon = new DB2Connecter("DB2"))
            {
                ...
                ds = dbCon.ExcuteDataSet("PSSCMLIB.PSM_PSM4041_SAFEORDER_CANCEL_SEQ");
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    for (i = 0; i < ds.Tables[0].Rows.Count; i++)
                    {
                        ...
                        mess.Subject = "[결재반려/안전작업허가서 - " + sWOWORKTITLE.ToString() + "]";
                        ...
                        try
                        {
                            ...
                            sLine += "        </tr> ";
                            sLine += "        <tr> ";
                            sLine += "            <th height=300 style = 'font-family:맑은 고딕,Verdana,sans-serif;width:120px;padding:10px 10px 10px 30px;;border-bottom:1px solid #EAEAEA;text-align:left; background:#DEDEEF;'> 반려의견 </th> ";
                            sLine += "            <td height=300 style = 'font-family:맑은 고딕,Verdana,sans-serif;padding:10px;border-bottom:1px solid #EAEAEA;'> " + sCANCELCOMMENT.ToString() + "</td> ";
                            sLine += "            <td height=300 style = 'width:80px;border-bottom:1px solid #EAEAEA;'> &nbsp;</td> ";
                            sLine += "        </tr> ";
                            sLine += "        <tr> ";
                            sLine += "            <th colspan = 3 style = 'font-family:맑은 고딕,Verdana,sans-serif;background:#e6e6dc;padding:10px; text-align:center;'> TAEYOUNG GROUPWARE ";
        ...
        #region Description : 안전작업허가서 결재 및 저장시 필드 체크
        public DataSet UP_FIELDCHECK(Hashtable ht)
        {
            using (DB2Connecter dbCon = new DB2Connecter("DB2"))
            {
                dbCon.AddParameters("P_KBSABUN1",  DbType.String, ht["P_SMSMSABUN"]);
                dbCon.AddParameters("P_DATE2",     DbType.String, ht["P_DATE"]);
                dbCon.AddParameters("P_TEAM2",     DbType.String, ht["P_SMREVTEAM"]);
                dbCon.AddParameters("P_LOGINID",   DbType.String, ht["P_LOGINID"]);
                dbCon.AddParameters("P_KBSABUN3",  DbType.String, ht["svSMOTAPPSABUN_KBSABUN"]);
                dbCon.AddParameters("P_KBSABUN4",  DbType.String, ht["svSMFSSABUN_KBSABUN"]);
                dbCon.AddParameters("P_KBSABUN5",  DbType.String, ht["svSMCNSABUN_KBSABUN"]);
                dbCon.AddParameters("P_KBSABUN6",  DbType.String, ht["P_SMCHKSABUN1"]);
                dbCon.AddParameters("P_KBSABUN7",  DbType.String, ht["P_SMCHKSABUN2"]);
                dbCon.AddParameters("P_KBSABUN8",  DbType.String, ht["P_SMCHKSABUN3"]);
                dbCon.AddParameters("P_KBSABUN9",  DbType.String, ht["P_SMCHKSABUN4"]);
                dbCon.AddParameters("P_KBSABUN10", DbType.String, ht["P_SMCHKSABUN5"]);
                dbCon.AddParameters("P_KBSABUN11", DbType.String, ht["P_SMCHKSABUN6"]);
                dbCon.AddParameters("P_KBSABUN12", DbType.String, ht["P_SMCHKSABUN7"]);
                dbCon.AddParameters("P_KBSABUN13", DbType.String, ht["P_SMCHKSABUN8"]);
                dbCon.AddParameters("P_FXCCODE14", DbType.String, ht["P_FXCCODE1"]);
                dbCon.AddParameters("P_FXCCODE15", DbType.String, ht["P_FXCCODE2"]);
                dbCon.AddParameters("P_FXCCODE16", DbType.String, ht["P_FXCCODE3"]);
                dbCon.AddParameters("P_FXCCODE17", DbType.String, ht["P_FXCCODE4"]);
                dbCon.AddParameters("P_FXCCODE18", DbType.String, ht["P_FXCCODE5"]);
                dbCon.AddParameters("P_L3CODE19",  DbType.String, ht["P_L3CODE1"]);
                dbCon.AddParameters("P_L3CODE20",  DbType.String, ht["P_L3CODE2"]);
                dbCon.AddParameters("P_L3CODE21",  DbType.String, ht["P_L3CODE3"]);
                dbCon.AddParameters("P_L3CODE22",  DbType.String, ht["P_L3CODE4"]);
                dbCon.AddParameters("P_L3CODE23",  DbType.String, ht["P_L3CODE5"]);
                dbCon.AddParameters("P_KBSABUN24", DbType.String, ht["P_801Sabun"]);
                dbCon.AddParameters("P_KBSABUN25", DbType.String, ht["P_802Sabun"]);
                dbCon.AddParameters("P_KBSABUN26", DbType.String, ht["P_803Sabun"]);
                dbCon.AddParameters("P_KBSABUN27", DbType.String, ht["P_804Sabun"]);
                dbCon.AddParameters("P_KBSABUN28", DbType.String, ht["P_805Sabun"]);

                return dbCon.ExcuteDataSet("PSSCMLIB.PSM_PSM4041_FIELDCHECK");
            }
        }
        #endregion
        ...
        private void UP_MAIL_SEND(Hashtable ht)
        {
            ...
            string sNext_Approval = string.Empty;
            ...
            sNext_Approval = ht["P_KBSABUN"].ToString();
            ...
            using (DB2Connecter dbCon = new DB2Connecter("DB2"))
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    for (i = 0; i < ds.Tables[0].Rows.Count; i++)
                    {
                        ...
                        //sUrl = "http://localhost:8110/Portal/SitePostUrl.aspx?url=http://localhost:8110/Portal/PortalLogin.aspx&ACTION=APPPAGE&SABUN=" + sKBSABUN + "&ID=" + sKBSABUN + "&LINKURL=" + sParamUrl;
            ...
            using (DB2Connecter dbCon = new DB2Connecter("DB2"))
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    for (i = 0; i < ds.Tables[0].Rows.Count; i++)
                    {
                        ...
                        //sUrl = "http://localhost:8110/Portal/SitePostUrl.aspx?url=http://localhost:8110/Portal/PortalLogin.aspx&ACTION=APPPAGE&SABUN=" + ds.Tables[0].Rows[i]["KBSABUN"].ToString() + "&ID=" + ds.Tables[0].Rows[i]["KBSABUN"].ToString() + "&LINKURL=" + sParamUrl;
        ...
        private void UP_Mail_WK_Send(string sWOORTEAM,      string sWOORDATE,    string sWOSEQ,
                                     string sSMWKORAPPDATE, string sSMWKORSEQ,
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        for (i = 0; i < ds.Tables[0].Rows.Count; i++)
                        {
                            ...
                            try
                            {
                                ...
                                sLine += "            <td style = 'font-family:맑은 고딕,Verdana,sans-serif;padding:10px;border-bottom:1px solid #EAEAEA;'> " + sSMFSWKTEXT.ToString().Replace("\n", "<br>") + "</td> ";
                                sLine += "            <td style = 'width:80px;border-bottom:1px solid #EAEAEA;'> &nbsp;</td> ";
                                sLine += "        </tr> ";
                                sLine += "        <tr> ";
                                sLine += "            <th colspan = 3 style = 'font-family:맑은 고딕,Verdana,sans-serif;background:#e6e6dc;padding:10px; text-align:center;'> TAEYOUNG GROUPWARE ";
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        try
                        {
                            ...
                            sLine += "            <td style = 'font-family:맑은 고딕,Verdana,sans-serif;padding:10px;border-bottom:1px solid #EAEAEA;'> " + sSMCNREASON.ToString().Replace("\n", "<br>") + "</td> ";
                            sLine += "            <td style = 'width:80px;border-bottom:1px solid #EAEAEA;'> &nbsp;</td> ";
                            sLine += "        </tr> ";
