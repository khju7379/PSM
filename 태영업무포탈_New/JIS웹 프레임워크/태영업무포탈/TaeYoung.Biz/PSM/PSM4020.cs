    ...
    public class PSM4020 : BizBase
    {
        ...
        public DataSet UP_GET_WORKORDER_LIST(Hashtable ht)
        {
            using (DB2Connecter dbCon = new DB2Connecter("DB2"))
            {
                ...
                return dbCon.ExcuteDataSet("PSSCMLIB.PSM_PSM4020_WORKORDER_LIST");
            }
        }
        #endregion
        ...
        #region Description : 변경요구서 확인
        public DataSet UP_CHANGEASK_RUN(Hashtable ht)
        {
            //System.Diagnostics.Debugger.Break();

            using (DB2Connecter dbCon = new DB2Connecter("DB2"))
            {
                dbCon.AddParameters("P_CAASKTEAM", DbType.String,     ht["P_CAASKTEAM"]);
                dbCon.AddParameters("P_CAASKDATE", DbType.String,     ht["P_CAASKDATE"]);
                dbCon.AddParameters("P_CAASKSEQ",  DbType.VarNumeric, ht["P_CAASKSEQ"]);

                return dbCon.ExcuteDataSet("PSSCMLIB.PSM_PSM4021_CHANGEASK_RUN");
            }
        }
        #endregion


        #region Description : 변경요구서 결재 DISPLAY
        public DataSet UP_PSM4021_APPROVAL_DISPLAY(Hashtable ht)
        {
            using (DB2Connecter dbCon = new DB2Connecter("DB2"))
            {
                dbCon.AddParameters("P_CAASKTEAM", DbType.String,     ht["P_CAASKTEAM"]);
                dbCon.AddParameters("P_CAASKDATE", DbType.String,     Get_Date(ht["P_CAASKDATE"].ToString()));
                dbCon.AddParameters("P_CAASKSEQ",  DbType.VarNumeric, Set_Fill3(ht["P_CAASKSEQ"].ToString()));

                return dbCon.ExcuteDataSet("PSSCMLIB.PSM_PSM4021_CHANGEASK_DOC_APP_DSP");
            }
        }
        #endregion

        #region Description : 변경요구서 순번 가져오기
        public DataSet UP_PSM4021_GET_MAX_SEQ(Hashtable ht)
        {
            using (DB2Connecter dbCon = new DB2Connecter("DB2"))
            {
                dbCon.AddParameters("P_CAASKTEAM", DbType.String, ht["P_CAASKTEAM"]);
                ...
                return dbCon.ExcuteDataSet("PSSCMLIB.PSM_PSM4021_GET_MAX_SEQ");
            }
        }
        #endregion


        #region Description : 변경요구서 저장 및 결재
        public DataSet UP_CHANGEASK_DOC_APPROVAL(Hashtable ht)
        {
            using (DB2Connecter dbCon = new DB2Connecter("DB2"))
            {
                dbCon.AddParameters("P_CAASKTEAM",       DbType.String, ht["P_CAASKTEAM"]);
                dbCon.AddParameters("P_CAASKDATE",       DbType.String, Get_Date(ht["P_CAASKDATE"].ToString()));
                dbCon.AddParameters("P_CAASKSEQ",        DbType.VarNumeric, Set_Fill3(ht["P_CAASKSEQ"].ToString()));
                dbCon.AddParameters("P_CAWOTEAM",        DbType.String, ht["P_CAWOTEAM"]);
                dbCon.AddParameters("P_CAWODATE",        DbType.String, Get_Date(ht["P_CAWODATE"].ToString()));
                dbCon.AddParameters("P_CAWOSEQ",         DbType.VarNumeric, Set_Fill3(ht["P_CAWOSEQ"].ToString()));
                dbCon.AddParameters("P_CAASKCONTENT",    DbType.String, ht["P_CAASKCONTENT"]);
                dbCon.AddParameters("P_CAASKBUSEO",      DbType.String, ht["P_CAASKBUSEO"]);
                dbCon.AddParameters("P_CAASKCLASS",      DbType.String, ht["P_CAASKCLASS"]);
                dbCon.AddParameters("P_CAASKSTEPGN",     DbType.String, ht["P_CAASKSTEPGN"]);
                dbCon.AddParameters("P_CAASKSUMMARY",    DbType.String, Convert.ToString(ht["P_CAASKSUMMARY"]).Replace("\r\n", "<br />").Replace("\n", "<br />"));
                dbCon.AddParameters("P_CAASKSABUN1",     DbType.String, ht["P_CAASKSABUN1"]);
                dbCon.AddParameters("P_CAASKNAME1",      DbType.String, ht["P_CAASKNAME1"]);
                dbCon.AddParameters("P_CAASKJKCD1",      DbType.String, ht["P_CAASKJKCD1"]);
                dbCon.AddParameters("P_CAASKJKCDNM1",    DbType.String, ht["P_CAASKJKCDNM1"]);
                dbCon.AddParameters("P_CAASKCOMMENT1",   DbType.String, ht["P_CAASKCOMMENT1"]);
                dbCon.AddParameters("P_CAASKSABUN2",     DbType.String, ht["P_CAASKSABUN2"]);
                dbCon.AddParameters("P_CAASKNAME2",      DbType.String, ht["P_CAASKNAME2"]);
                dbCon.AddParameters("P_CAASKJKCD2",      DbType.String, ht["P_CAASKJKCD2"]);
                dbCon.AddParameters("P_CAASKJKCDNM2",    DbType.String, ht["P_CAASKJKCDNM2"]);
                dbCon.AddParameters("P_CAASKCOMMENT2",   DbType.String, ht["P_CAASKCOMMENT2"]);
                dbCon.AddParameters("P_CAASKSABUN3",     DbType.String, ht["P_CAASKSABUN3"]);
                dbCon.AddParameters("P_CAASKNAME3",      DbType.String, ht["P_CAASKNAME3"]);
                dbCon.AddParameters("P_CAASKJKCD3",      DbType.String, ht["P_CAASKJKCD3"]);
                dbCon.AddParameters("P_CAASKJKCDNM3",    DbType.String, ht["P_CAASKJKCDNM3"]);
                dbCon.AddParameters("P_CAASKCOMMENT3",   DbType.String, ht["P_CAASKCOMMENT3"]);
                dbCon.AddParameters("P_CAASKSABUN4",     DbType.String, ht["P_CAASKSABUN4"]);
                dbCon.AddParameters("P_CAASKNAME4",      DbType.String, ht["P_CAASKNAME4"]);
                dbCon.AddParameters("P_CAASKJKCD4",      DbType.String, ht["P_CAASKJKCD4"]);
                dbCon.AddParameters("P_CAASKJKCDNM4",    DbType.String, ht["P_CAASKJKCDNM4"]);
                dbCon.AddParameters("P_CAASKCOMMENT4",   DbType.String, ht["P_CAASKCOMMENT4"]);
                dbCon.AddParameters("P_CAASKSABUN5",     DbType.String, ht["P_CAASKSABUN5"]);
                dbCon.AddParameters("P_CAASKNAME5",      DbType.String, ht["P_CAASKNAME5"]);
                dbCon.AddParameters("P_CAASKJKCD5",      DbType.String, ht["P_CAASKJKCD5"]);
                dbCon.AddParameters("P_CAASKJKCDNM5",    DbType.String, ht["P_CAASKJKCDNM5"]);
                dbCon.AddParameters("P_CAASKCOMMENT5",   DbType.String, ht["P_CAASKCOMMENT5"]);
                dbCon.AddParameters("P_CAASKRESABUN1",   DbType.String, ht["P_CAASKRESABUN1"]);
                dbCon.AddParameters("P_CAASKRENAME1",    DbType.String, ht["P_CAASKRENAME1"]);
                dbCon.AddParameters("P_CAASKREJKCD1",    DbType.String, ht["P_CAASKREJKCD1"]);
                dbCon.AddParameters("P_CAASKREJKCDNM1",  DbType.String, ht["P_CAASKREJKCDNM1"]);
                dbCon.AddParameters("P_CAASKRECOMMENT1", DbType.String, ht["P_CAASKRECOMMENT1"]);
                dbCon.AddParameters("P_CAASKRESABUN2",   DbType.String, ht["P_CAASKRESABUN2"]);
                dbCon.AddParameters("P_CAASKRENAME2",    DbType.String, ht["P_CAASKRENAME2"]);
                dbCon.AddParameters("P_CAASKREJKCD2",    DbType.String, ht["P_CAASKREJKCD2"]);
                dbCon.AddParameters("P_CAASKREJKCDNM2",  DbType.String, ht["P_CAASKREJKCDNM2"]);
                dbCon.AddParameters("P_CAASKRECOMMENT2", DbType.String, ht["P_CAASKRECOMMENT2"]);
                dbCon.AddParameters("P_CAASKRESABUN3",   DbType.String, ht["P_CAASKRESABUN3"]);
                dbCon.AddParameters("P_CAASKRENAME3",    DbType.String, ht["P_CAASKRENAME3"]);
                dbCon.AddParameters("P_CAASKREJKCD3",    DbType.String, ht["P_CAASKREJKCD3"]);
                dbCon.AddParameters("P_CAASKREJKCDNM3",  DbType.String, ht["P_CAASKREJKCDNM3"]);
                dbCon.AddParameters("P_CAASKRECOMMENT3", DbType.String, ht["P_CAASKRECOMMENT3"]);
                dbCon.AddParameters("P_CAASKRESABUN4",   DbType.String, ht["P_CAASKRESABUN4"]);
                dbCon.AddParameters("P_CAASKRENAME4",    DbType.String, ht["P_CAASKRENAME4"]);
                dbCon.AddParameters("P_CAASKREJKCD4",    DbType.String, ht["P_CAASKREJKCD4"]);
                dbCon.AddParameters("P_CAASKREJKCDNM4",  DbType.String, ht["P_CAASKREJKCDNM4"]);
                dbCon.AddParameters("P_CAASKRECOMMENT4", DbType.String, ht["P_CAASKRECOMMENT4"]);
                dbCon.AddParameters("P_CAASKRESABUN5",   DbType.String, ht["P_CAASKRESABUN5"]);
                dbCon.AddParameters("P_CAASKRENAME5",    DbType.String, ht["P_CAASKRENAME5"]);
                dbCon.AddParameters("P_CAASKREJKCD5",    DbType.String, ht["P_CAASKREJKCD5"]);
                dbCon.AddParameters("P_CAASKREJKCDNM5",  DbType.String, ht["P_CAASKREJKCDNM5"]);
                dbCon.AddParameters("P_CAASKRECOMMENT5", DbType.String, ht["P_CAASKRECOMMENT5"]);
                dbCon.AddParameters("P_CAASKHISAB",      DbType.String, ht["P_CAASKHISAB"]);
                ...
                return dbCon.ExcuteDataSet("PSSCMLIB.PSM_PSM4021_CHANGEASK_DOC_APPROVAL");
            }
        }
        #endregion

        #region Description : 변경요구서 삭제
        public DataSet UP_CHANGEASK_DEL(Hashtable ht)
        {
            DataSet ds = new DataSet();
            DataTable dt = new DataTable();
            DataRow row;
            ...
            using (DB2Connecter dbCon = new DB2Connecter("DB2"))
            {
                ...
                dbCon.ExcuteNonQuery("PSSCMLIB.PSM_PSM4021_CHANGEASK_DEL");
        ...
        #region Description : 변경요구서 반려
        public DataSet UP_CHANGEASK_CANCEL(Hashtable ht)
        {
            DataSet ds = new DataSet();
            DataTable dt = new DataTable();
            DataRow row;
            ...
            using (DB2Connecter dbCon = new DB2Connecter("DB2"))
            {
                ...
                dbCon.ExcuteNonQuery("PSSCMLIB.PSM_PSM4021_CHANGEASK_CANCEL");
        ...
        #region Description : 변경요구서 철회
        public DataSet UP_CHANGEASK_RETRACT(Hashtable ht)
        {
            DataSet ds   = new DataSet();
            DataTable dt = new DataTable();
            DataRow row;
        ...
        #region Description : 변경요구서 접수일자 업데이트
        public DataSet UP_CHANGEASK_RECEIPT_UPT(Hashtable ht)
        {
            DataSet ds = new DataSet();
            DataSet retds = new DataSet();
            DataTable dt = new DataTable();
            ...
            using (DB2Connecter dbCon = new DB2Connecter("DB2"))
            {
                ...
                return dbCon.ExcuteDataSet("PSSCMLIB.PSM_PSM4021_CHANGEASK_RECEIPT_UPT");
            }
        }
        #endregion
        ...
        public DataSet UP_Get_Mail_List(Hashtable ht)
        {
            ...
            string sCAASKCONTENT = string.Empty;
            string sCAASKSUMMARY = string.Empty;
            string sGUBUN = string.Empty;
            string sFINISH = string.Empty;
            string sCAASKCLASS = string.Empty;
            ...
            sCAASKCONTENT = ht["P_CAASKCONTENT"].ToString();
            sCAASKSUMMARY = ht["P_CAASKSUMMARY"].ToString();
            ...
            try
            {
                // 변경요구서 요청자 결재 전결 후 첫 수신자로 메일 발송 시
                // 1. 안전환경팀은 무조건 전체 메일 보냄
                // 2. 변경종류가 화물이면 운영팀에도 메일 발송함
                if (ht["P_REGUBUN"].ToString() == "FIRST")
                {
                    using (DB2Connecter dbCon = new DB2Connecter("DB2"))
                    {
                        // 1 = 화물(청소 미포함)
                        ...
                        {
                            // 안전환경팀 및 운영팀 팀장, 대리메일 계정 가져오기
                            sGRPID = "SAFE_MAG,UTT_OPERA";
                        }
                        else
                        {
                            // 안전환경팀 메일 계정 가져오기
                ...
                if (ht["P_REGUBUN"].ToString() == "LAST") // 수신 전결시
                {
                    // 변경등급
                    if (ht["P_CAASKCLASS"].ToString() == "A" || ht["P_CAASKCLASS"].ToString() == "B")
                    {
                        using (DB2Connecter dbCon = new DB2Connecter("DB2"))
                        {
                            // 안전환경팀 메일 계정 가져오기
                    ...
                    else if (ht["P_CAASKCLASS"].ToString() == "C")
                    {
                        using (DB2Connecter dbCon = new DB2Connecter("DB2"))
                        {
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        for (i = 0; i < ds.Tables[0].Rows.Count; i++)
                        {
                            ...
                            try
                            {
                                ...
                                sLine += "    <tbody> ";
                                sLine += "        <tr> ";
                                sLine += "            <th colspan = 2 style = 'font-family:맑은 고딕,Verdana,sans-serif;height:50px;font-weight:bold;background:#ab2457; font-size:18px;color:#FFFFFF;text-align:center; vertical-align:middle;'> 변경요구서 </th> ";
                                sLine += "                <td style = 'width:100px;border-bottom:1px solid #EAEAEA;background:#ab2457;'> ";
                                sLine += "                    <a href='" + sUrl.ToString().Replace("&amp", "&") + "'&WIDTH=1200&HEIGHT=1000 target=_blank> ";
                                sLine += "                    <img src = 'http://psm.taeyoung.co.kr/Resources/Framework/doc_display.png' alt = '문서보기' )=></a> ";
                                sLine += "                </td> ";
                                sLine += "            </tr> ";
                                sLine += "        <tr> ";
                                sLine += "            <th style = 'font-family:맑은 고딕,Verdana,sans-serif;width:120px;padding:10px 10px 10px 30px;;border-bottom:1px solid #EAEAEA;text-align:left; background:#DEDEEF;'> 변경요구번호 </th> ";
                                ...
                                sLine += "        </tr> ";
                                sLine += "        <tr> ";
                                sLine += "            <th style = 'font-family:맑은 고딕,Verdana,sans-serif;width:120px;padding:10px 10px 10px 30px;;border-bottom:1px solid #EAEAEA;text-align:left; background:#DEDEEF;'> 설비명 또는 변경요소 </th> ";
                                sLine += "            <td style = 'font-family:맑은 고딕,Verdana,sans-serif;padding:10px;border-bottom:1px solid #EAEAEA;'> " + ht["P_CAASKCONTENT"].ToString() + " </td> ";
                                sLine += "            <td style = 'width:80px;border-bottom:1px solid #EAEAEA;'> &nbsp;</td> ";
                                sLine += "        </tr> ";

                                if (ht["P_CAASKSUMMARY"].ToString() != "")
                                {
                                    sLine += "        <tr> ";
                                    sLine += "            <th height=300 style = 'font-family:맑은 고딕,Verdana,sans-serif;width:120px;padding:10px 10px 10px 30px;;border-bottom:1px solid #EAEAEA;text-align:left; background:#DEDEEF;'> 변경개요 </th> ";
                                    sLine += "            <td height=300 style = 'font-family:맑은 고딕,Verdana,sans-serif;padding:10px;border-bottom:1px solid #EAEAEA;'> " + ht["P_CAASKSUMMARY"].ToString().Replace("\n", "<br>") + " </td> ";
                                ...
                                if (ht["P_REGUBUN"].ToString() == "LAST") // 수신 전결시
                                {
                                    ...
                                    if (ht["P_CAASKCLASS"].ToString() == "C")
                                    {
                                        sLine += "            <td style = 'font-family:맑은 고딕,Verdana,sans-serif;padding:10px;border-bottom:1px solid #EAEAEA;'> 작업허가서 작업을 진행하시기 바랍니다. </td> ";
                                    }
                                    else
                                    {
                                        sLine += "            <td style = 'font-family:맑은 고딕,Verdana,sans-serif;padding:10px;border-bottom:1px solid #EAEAEA;'> 변경검토서 작업을 진행하시기 바랍니다. </td> ";
                                    }
                                }
        ...
        #region Description : 변경요구서 결재철회 메일 발송
        private DataSet UP_RETRACT_Mail_Send(Hashtable ht)
        {
            ...
            string sCAASKTEAM    = string.Empty;
            string sCAASKDATE    = string.Empty;
            string sCAASKSEQ     = string.Empty;
            ...
            sCAASKTEAM    = ht["P_CAASKTEAM"].ToString();
            sCAASKDATE    = Get_Date(ht["P_CAASKDATE"].ToString());
            sCAASKSEQ     = Set_Fill3(ht["P_CAASKSEQ"].ToString());
            ...
            {
                // 수신자 메일 계정 가져오기
                dbCon.AddParameters("P_CAASKTEAM", DbType.String,     sCAASKTEAM);
                dbCon.AddParameters("P_CAASKDATE", DbType.String,     sCAASKDATE);
                dbCon.AddParameters("P_CAASKSEQ",  DbType.VarNumeric, sCAASKSEQ);

                ds = dbCon.ExcuteDataSet("PSSCMLIB.PSM_PSM4021_GET_SOSABUN");
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    sTITLE = "결재철회/변경요구서 - " + sCAASKCONTENT.ToString();
                    ...
                    try
                    {
                        ...
                        sLine += "            <td style = 'font-family:맑은 고딕,Verdana,sans-serif;padding:10px;border-bottom:1px solid #EAEAEA;'> " + sCAASKCONTENT.ToString() + " </td> ";
                        sLine += "            <td style = 'width:80px;border-bottom:1px solid #EAEAEA;'> &nbsp;</td> ";
                        sLine += "        </tr> ";
                        sLine += "        <tr> ";
                        sLine += "            <th colspan = 3 style = 'font-family:맑은 고딕,Verdana,sans-serif;background:#e6e6dc;padding:10px; text-align:center;'> TAEYOUNG GROUPWARE ";
        ...
        public DataSet UP_GET_CHANGEASK_LIST(Hashtable ht)
        {
            using (DB2Connecter dbCon = new DB2Connecter("DB2"))
            {
                ...
                return dbCon.ExcuteDataSet("PSSCMLIB.PSM_PSM4020_CHANGEASK_LIST");
            }
        }
        #endregion

        #region Description : 변경요구서 출력
        public DataSet UP_CHANGEASK_DOC_PRT(Hashtable ht)
        {
            using (DB2Connecter dbCon = new DB2Connecter("DB2"))
            {
                dbCon.AddParameters("P_CAASKTEAM", DbType.String, ht["P_CAASKTEAM"]);
                ...
                return dbCon.ExcuteDataSet("PSSCMLIB.PSM_PSM4021_CHANGEASK_DOC_PRT");
            }
        }
        #endregion
