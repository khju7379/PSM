declare module cfx {
    ...
    export enum PieLabelLayout {
        Straight,
        Radial,
        BorderPath
    }

    export enum PieLabelOutside {
        None,
        AsNeeded,
        Centered
    }

    export enum PointLabelColor {
        Auto,
        Outside,
        Fill
    }
    ...
    export class HighLow extends IGalleryType {
        ...
        getShadowSameAsBody(): boolean;
        setShadowSameAsBody(value: boolean): void;
        getShadowVolume(): number;
        setShadowVolume(value: number): void;
        getSingleColor(): boolean;
        setSingleColor(value: boolean): void;
        getWingVolume(): number;
        setWingVolume(value: number): void;
    }
    ...
    export class NumberFieldCondition extends ICondition {
        ...
        getFromValueName(): string;
        setFromValueName(value: string): void;
    ...
    export class DrillDownLevel {
        ...
        getHandler(): any;
        setHandler(value: any): void;
        getOldData(): any;
        setOldData(value: any): void;
        getSeries(): number;
    ...
    export class VectorPie extends IGalleryType {
        ...
        getLabelLayouts(): PieLabelLayout[];
        setLabelLayouts(value: PieLabelLayout[]): void;
        getLabelLineBreak(): number;
        setLabelLineBreak(value: number): void;
        getLabelOutside(): PieLabelOutside;
        setLabelOutside(value: PieLabelOutside): void;
        getLabelSingleLayout(): boolean;
        setLabelSingleLayout(value: boolean): void;
    ...
    export class VectorBubble extends IGalleryType {
        ...
        getUseMarkers(): boolean;
        setUseMarkers(value: boolean): void;
    }
    ...
    export class DrillDownLevelCollection {
        getCount(): number;
        getItem(index: number): DrillDownLevel;
        add(drillDownLevel: DrillDownLevel): void;
        remove(drillDownLevel: DrillDownLevel): void;
    }

    export class DrillDownAttributes {
        getCurrentLevel(): number;
        getLevels(): DrillDownLevelCollection;
        getStack(): DrillDownLevelCollection;
    }
    ...
    export class PointLabelAttributes {
        ...
        setTextColor(value: string): void;
        getTextColorMethod(): PointLabelColor;
        setTextColorMethod(value: PointLabelColor): void;
    ...
    export class Title {
        ...
        /** Assigns a font to the specified title. */
        setFont(value: string): void;
        getForceAlignment(): boolean;
        setForceAlignment(value: boolean): void;
        ...
        setSeparation(value: number): void;
        getSizeExternal(): any;
        setSizeExternal(value: any): void;
        getTag(): string;
        setTag(value: string): void;
        getTemplate(): string;
        setTemplate(value: string): void;
    ...
    export class Chart {
        ...
        getDrillDown(): DrillDownAttributes;
    ...
    export module annotation {
        ...
        export class AnnotationObject {
            ...
            getAttachAxisY(): Axis;
            setAttachAxisY(value: Axis): void;
            getAttachUnitX(): AttachUnit;
            setAttachUnitX(value: AttachUnit): void;
            getAttachUnitY(): AttachUnit;
            setAttachUnitY(value: AttachUnit): void;
        ...
        export class AnnotationText extends AnnotationObject {
            ...
            getResizeableFont(): boolean;
            setResizeableFont(value: boolean): void;
    ...
    export module highlow {
        export class HighLow extends IGalleryType {
            ...
            getEqualsToLine(): string;
            setEqualsToLine(value: string): void;
            getEqualsToTag(): string;
            setEqualsToTag(value: string): void;
            getLessThanColor(): string;
            setLessThanColor(value: string): void;
            getLessThanLine(): string;
            setLessThanLine(value: string): void;
            getLessThanTag(): string;
            setLessThanTag(value: string): void;
            getSingleArea(): boolean;
            setSingleArea(value: boolean): void;
            getTemplate(): string;
            setTemplate(value: string): void;
        }
    }
    ...
    export module maps {
        ...
        export class Map extends IGalleryType {
            ...
            getChart(): any;
            getContextDataTemplate(): string;
            setContextDataTemplate(value: string): void;
    ...
    export module financial {
        ...
        export enum AnalyticalStudy {
            Unknown,
            SimpleMovingAverage,
            SimpleMovingAverage10,
        ...
        export class StudySeries {
            constructor();
            getAttributes(): SeriesAttributes;
            setAttributes(value: SeriesAttributes): void;
            getValue(index: number): number;
        }

        export class IntraDaySettings {
            constructor();
            getCustomMarketCloseTime(): number;
            setCustomMarketCloseTime(value: number): void;
            getEnabled(): boolean;
            setEnabled(value: boolean): void;
            getInterval(): IntraDayInterval;
            setInterval(value: IntraDayInterval): void;
            getMarketCloseTime(): MarketTime;
            setMarketCloseTime(value: MarketTime): void;
            getStep(): number;
        }
        ...
        export class CompressionSettings {
            ...
            getEnabled(): boolean;
            setEnabled(value: boolean): void;
            getInterval(): Compression;
            setInterval(value: Compression): void;
        }

        export class DataBindingSettings {
            getCloseSeries(): number;
            setCloseSeries(value: number): void;
            getDefault4SeriesHaveVolume(): boolean;
            setDefault4SeriesHaveVolume(value: boolean): void;
            getHighSeries(): number;
            setHighSeries(value: number): void;
            getLowSeries(): number;
            setLowSeries(value: number): void;
            getOpenSeries(): number;
            setOpenSeries(value: number): void;
            getVolumeSeries(): number;
            setVolumeSeries(value: number): void;
            refresh(): void;
            reset(): void;
            resetDefaultedBinding(): void;
        }

        export class SeriesAttributesF {
            constructor();
            getBorder(): BorderAttributes;
            getGallery(): Gallery;
            setGallery(value: Gallery): void;
        ...
        export class JapaneseSeriesAttributes extends SeriesAttributesF {
            constructor();
        }

        export class KagiSeriesAttributes extends JapaneseSeriesAttributes {
            constructor();
        }

        export class Study {
            getAxisY(): AxisY;
            getDataSeries(): SourceData;
            setDataSeries(value: SourceData): void;
            getIsPriceStudy(): boolean;
            getName(): string;
            setName(value: string): void;
            getSeries(): StudySeriesCollection;
            getShowIncompleteResult(): boolean;
            setShowIncompleteResult(value: boolean): void;
            getVisible(): boolean;
            setVisible(value: boolean): void;
            getItem(point: number): number;
        }

        export class PricesStudy extends Study {
            getIsPriceStudy(): boolean;
        }

        export class SimpleMovingAverage extends PricesStudy {
            constructor();
            getPeriods(): number;
            setPeriods(value: number): void;
        }

        export class WeightedMovingAverage extends SimpleMovingAverage {
            constructor();
            getPeriods(): number;
            setPeriods(value: number): void;
        }

        export class TriangularMovingAverage extends SimpleMovingAverage {
            constructor();
        }

        export class SimpleMovingAverage50 extends SimpleMovingAverage {
            constructor();
        }

        export class SimpleMovingAverage200 extends SimpleMovingAverage {
            constructor();
        }

        export class SimpleMovingAverage10 extends SimpleMovingAverage {
            constructor();
        }

        export class ExponentialMovingAverage extends SimpleMovingAverage {
            constructor();
        }

        export class DynamicSeriesSMA extends SimpleMovingAverage {
            constructor();
        }

        export class Envelopes extends DynamicSeriesSMA {
            constructor();
            getShift(): number;
            setShift(value: number): void;
        }
                    export enum Envelopes_SubIndicator {
                UpperBand,
                LowerBand
            }

        export class BollingerBands extends DynamicSeriesSMA {
            constructor();
            getDeviations(): number;
            setDeviations(value: number): void;
        }
                    export enum BollingerBands_SubIndicator {
                UpperBand,
                LowerBand
            }

        export class PriceCalculation extends PricesStudy {
        }

        export class TypicalPrice extends PriceCalculation {
            constructor();
        }

        export class WeightedClose extends TypicalPrice {
            constructor();
        }

        export class MedianPrice extends PriceCalculation {
            constructor();
        }

        export class NonPricesStudy extends PricesStudy {
            getIsPriceStudy(): boolean;
            getPaneIndex(): number;
            setPaneIndex(value: number): void;
        }

        export class PeriodsTechnicalStudy extends NonPricesStudy {
            constructor();
            getPeriods(): number;
            setPeriods(value: number): void;
        }

        export class VerticalHorizontalFilter extends PeriodsTechnicalStudy {
            constructor();
        }

        export class TRIX extends PeriodsTechnicalStudy {
            constructor();
            getSignalPeriod(): number;
            setSignalPeriod(value: number): void;
        }
                    export enum TRIX_SubIndicator {
                TRIX,
                MovingAverage
            }

        export class StandardDeviation extends PeriodsTechnicalStudy {
            constructor();
        }

        export class RelativeStrengthIndex extends PeriodsTechnicalStudy {
            constructor();
        }

        export class RateOfChange extends PeriodsTechnicalStudy {
            constructor();
        }

        export class PercentualRateOfChange extends RateOfChange {
            constructor();
        }

        export class Momentum extends PeriodsTechnicalStudy {
            constructor();
        }

        export class DetrendedPriceOscillator extends PeriodsTechnicalStudy {
            constructor();
        }

        export class Performance extends NonPricesStudy {
            constructor();
        }

        export class NonFreeTechStudy extends NonPricesStudy {
        }

        export class VolumeStudy extends NonFreeTechStudy {
        }

        export class VolumeOscillator extends VolumeStudy {
            constructor();
            getLongPeriod(): number;
            setLongPeriod(value: number): void;
            getShortPeriod(): number;
            setShortPeriod(value: number): void;
        }

        export class CloseVolumeStudy extends VolumeStudy {
        }

        export class PriceAndVolumeTrend extends CloseVolumeStudy {
            constructor();
        }

        export class OnBalanceVolume extends CloseVolumeStudy {
            constructor();
        }

        export class NegativeVolumeIndex extends CloseVolumeStudy {
            constructor();
            getPeriods(): number;
            setPeriods(value: number): void;
            ...
            setStartValue(value: number): void;
                    ...
                    export enum NegativeVolumeIndex_SubIndicator {
                VolumeIndex,
                MovingAverage
            }

        export class PositiveVolumeIndex extends NegativeVolumeIndex {
            constructor();
        }

        export class HighLowStudy extends NonFreeTechStudy {
        }

        export class VolumeHighLowStudy extends HighLowStudy {
        }

        export class EaseOfMovement extends VolumeHighLowStudy {
            constructor();
            getPeriods(): number;
            setPeriods(value: number): void;
            getSignalPeriods(): number;
            setSignalPeriods(value: number): void;
        }
                    export enum EaseOfMovement_SubIndicator {
                EaseOM,
                MovingAverage
            }

        export class VolatilityChaikins extends HighLowStudy {
            constructor();
            getPeriods(): number;
            setPeriods(value: number): void;
            getShiftDays(): number;
            setShiftDays(value: number): void;
        }

        export class MassIndex extends HighLowStudy {
            constructor();
            getPeriods(): number;
            setPeriods(value: number): void;
        }

        export class HighLowCloseStudy extends HighLowStudy {
        }

        export class Stochastics extends HighLowCloseStudy {
            constructor();
            getDPeriods(): number;
            setDPeriods(value: number): void;
            getKPeriods(): number;
            setKPeriods(value: number): void;
        }
                    export enum Stochastics_SubIndicator {
                StochasticsK,
                StochasticsD
            }

        export class HighLowCloseVolumeStudy extends HighLowCloseStudy {
        }

        export class MoneyFlowIndex extends HighLowCloseVolumeStudy {
            constructor();
            getPeriods(): number;
            setPeriods(value: number): void;
        }

        export class ChaikinOscillator extends HighLowCloseVolumeStudy {
            constructor();
            getLongPeriod(): number;
            setLongPeriod(value: number): void;
            getShortPeriod(): number;
        ...
        export class AccumulationDistribution extends HighLowCloseVolumeStudy {
            constructor();
        }

        export class AverageTrueRange extends HighLowCloseStudy {
            constructor();
            getPeriods(): number;
            setPeriods(value: number): void;
        }

        export class WilliamsR extends AverageTrueRange {
            constructor();
        }

        export class CommodityChannelIndex extends WilliamsR {
            constructor();
        }

        export class MACD extends NonPricesStudy {
            constructor();
            getLongPeriod(): number;
            setLongPeriod(value: number): void;
            getShortPeriod(): number;
            ...
            setSignalPeriod(value: number): void;
                    ...
                    export enum MACD_SubIndicator {
                Divergence,
                MACD,
                Signal
            }

        export class DualTypeStudy extends NonPricesStudy {
            constructor();
            getIsPriceStudy(): boolean;
        }

        export class StaticStudy extends DualTypeStudy {
            constructor();
        }

        export class Volume extends StaticStudy {
            constructor();
        }

        export class DrawingFeature {
            constructor();
            getDrawSeries(): DrawSeries;
            setDrawSeries(value: DrawSeries): void;
            getEndDate(): any;
        ...
        export class TrendLine extends DrawingFeature {
            constructor();
        }

        export class SpeedResistanceLines extends DrawingFeature {
            constructor();
        }

        export class SignalDrawingFeature extends DrawingFeature {
            constructor();
            getSignalLineStyle(): any;
            setSignalLineStyle(value: any): void;
        }

        export class QuadrantLines extends SignalDrawingFeature {
            constructor();
        }

        export class MidpointTironeLevels extends SignalDrawingFeature {
            constructor();
        }

        export class MeanTironeLevels extends MidpointTironeLevels {
            constructor();
        }

        export class FibonacciTimeZones extends SignalDrawingFeature {
            constructor();
        }

        export class FibonacciRetracement extends SignalDrawingFeature {
            constructor();
        }

        export class FibonacciFan extends SignalDrawingFeature {
            constructor();
        }

        export class FibonacciArcs extends SignalDrawingFeature {
            constructor();
        }

        export class GannFan extends DrawingFeature {
            constructor();
        }
        ...
        export class DrawingsCollection extends BaseCollection {
            constructor();
            getItem(n: number): DrawingFeature;
            add(drawingID: AnalyticalDrawing): DrawingFeature;
            addDrawing(obj: DrawingFeature): void;
            contains(obj: DrawingFeature): boolean;
            indexOf(obj: DrawingFeature): number;
            insert(index: number, obj: DrawingFeature): void;
            remove(obj: DrawingFeature): void;
        }

        export class StudiesCollection extends BaseCollection {
            getItem(n: number): Study;
            add(studyID: AnalyticalStudy): Study;
            addStudy(obj: Study): void;
            contains(obj: Study): boolean;
            findStudy(analyticalStudy: AnalyticalStudy): Study;
            indexOf(obj: Study): number;
            insert(index: number, obj: Study): void;
            remove(obj: Study): void;
        }

        export class StudySeriesCollection {
            constructor();
            getItem(n: number): SeriesAttributes;
        }

        export class FinancialGallery extends IGalleryType {
            protected _internal_IGalleryType(): void;
            constructor();
            resumeUpdate(): void;
            suspendUpdate(): void;
        ...
        export class Analytical extends FinancialGallery {
            constructor();
            getCloseGallery(): Gallery;
            setCloseGallery(value: Gallery): void;
            getClosePriceSeries(): SeriesAttributes;
            getDrawings(): DrawingsCollection;
            getHighPriceSeries(): SeriesAttributes;
            getIntraDay(): IntraDaySettings;
            getLowPriceSeries(): SeriesAttributes;
            getMaxPanes(): number;
            setMaxPanes(value: number): void;
            getOpenPriceSeries(): SeriesAttributes;
            getPriceDisplay(): PriceDisplay;
            setPriceDisplay(value: PriceDisplay): void;
            getPricesLegendText(): string;
            setPricesLegendText(value: string): void;
            getPriceTitleMask(): string;
            setPriceTitleMask(value: string): void;
            getShowIncompleteResult(): boolean;
            setShowIncompleteResult(value: boolean): void;
            getStudies(): StudiesCollection;
        }

        export class JapaneseGallery extends FinancialGallery {
            constructor();
            getDataSeries(): SourceData;
            setDataSeries(value: SourceData): void;
            getDownPointsSeries(): JapaneseSeriesAttributes;
            getSingleColor(): boolean;
            setSingleColor(value: boolean): void;
            getUpPointsSeries(): JapaneseSeriesAttributes;
        }

        export class UpDownBox extends JapaneseGallery {
        }

        export class ThreeLineBreak extends UpDownBox {
            constructor();
            getBreakDays(): number;
            setBreakDays(value: number): void;
        }

        export class PointAndFigure extends UpDownBox {
            constructor();
            getBoxSize(): number;
            setBoxSize(value: number): void;
            getDrawShadows(): boolean;
            setDrawShadows(value: boolean): void;
            getIsPercentualBox(): boolean;
            setIsPercentualBox(value: boolean): void;
            getIsRectangularMarker(): boolean;
            setIsRectangularMarker(value: boolean): void;
            getUseHighLowPrices(): boolean;
            setUseHighLowPrices(value: boolean): void;
        }

        export class Kagi extends UpDownBox {
            constructor();
            getDownPointsSeries(): JapaneseSeriesAttributes;
            getIsPercentualReversal(): boolean;
            setIsPercentualReversal(value: boolean): void;
            getReversalAmount(): number;
            setReversalAmount(value: number): void;
            getUpPointsSeries(): JapaneseSeriesAttributes;
            getYangSeries(): KagiSeriesAttributes;
            getYinSeries(): KagiSeriesAttributes;
        }

        export class Renko extends UpDownBox {
            constructor();
            getBoxSize(): number;
            setBoxSize(value: number): void;
            getIsPercentualBox(): boolean;
        ...
        export class Galleries {
            constructor();
            getAnalytical(): Analytical;
            getCurrent(): GalleryFinancial;
            setCurrent(value: GalleryFinancial): void;
            getKagi(): Kagi;
            getPointAndFigure(): PointAndFigure;
            getRenko(): Renko;
            getThreeLineBreak(): ThreeLineBreak;
        }

        export class Financial {
            constructor();
            getCompression(): CompressionSettings;
            getCulture(): any;
            setCulture(value: any): void;
            getDataBindingSettings(): DataBindingSettings;
            getGallery(): Galleries;
        }
    }

    export module nodexy {
        ...
        export class LabelOrganizer {
            constructor();
            getAvailablePositions(): LabelPositions;
            setAvailablePositions(value: LabelPositions): void;
            getDirty(): boolean;
        ...
        export class NodeTypeCollection {
            constructor();
            getItem(index: number): NodeType;
            setItem(index: number, value: NodeType): void;
            add(nodeType: NodeType): void;
            clear(): void;
        }

        export class NodeXY extends IGalleryType {
            protected _internal_IGalleryType(): void;
            constructor();
            ...
            setLabelField(value: string): void;
            getLabelOrganizer(): LabelOrganizer;
            getLevelField(): string;
            setLevelField(value: string): void;
            getMaxPercent(): number;
            setMaxPercent(value: number): void;
            getMaxSize(): number;
            setMaxSize(value: number): void;
            ...
            setMinSize(value: number): void;
            getSizeField(): string;
            setSizeField(value: string): void;
            getTypeField(): string;
            setTypeField(value: string): void;
            getTypes(): NodeTypeCollection;
            getVertex(): Line;
            getVerticesField(): string;
            setVerticesField(value: string): void;
            findNodes(series: number, point: number, style: number): any;
            findVertices(series: number, point: number, style: number): any;
        }
    }

    export module sunburst {
        export enum SunBurstColoring {
            PerElem,
            PerLevel
        }

        export class SunBurstValue {
            getIndex(): number;
            getIsOpened(): boolean;
        ...
        export class SunBurstLevelCollection {
            constructor();
            getCount(): number;
            getItem(index: number): SunBurstLevel;
        }

        export class SunBurstValueCollection {
            constructor();
            getCount(): number;
            getItem(index: number): SunBurstValue;
        }

        export class SunBurstLevel {
            getValues(): SunBurstValueCollection;
        }

        export class SunBurst extends IGalleryType {
            protected _internal_IGalleryType(): void;
            constructor();
            getColoring(): SunBurstColoring;
            setColoring(value: SunBurstColoring): void;
            getExploded(): boolean;
            setExploded(value: boolean): void;
            getHoleRatio(): number;
            setHoleRatio(value: number): void;
            getLevels(): SunBurstLevelCollection;
            getTemplate(): string;
            setTemplate(value: string): void;
        }
    }
    ...
    export module gauge {
        ...
        export class IndicatorSettings {
            ...
            getReuseBackgroundColor(): boolean;
            setReuseBackgroundColor(value: boolean): void;
        ...
        export class Title extends GaugeElement {
            ...
            setAlignment(value: StringAlignment): void;
            getAllowMain(): boolean;
            setAllowMain(value: boolean): void;
            getAnchor(): Anchor;
        ...
        export class Border extends BorderedControl {
            ...
            setHorizontalGap(value: number): void;
            ...
            setLayout(value: BorderLayout): void;
            ...
            setVerticalGap(value: number): void;
